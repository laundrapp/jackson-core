...
/*!
 @brief Factory method that will construct a pointer instance that describes
  path to location given <code>TokenStreamContext</code> points to.
...
FOUNDATION_EXPORT ComFasterxmlJacksonCoreJsonPointer *ComFasterxmlJacksonCoreJsonPointer_forPathWithComFasterxmlJacksonCoreTokenStreamContext_withBoolean_(ComFasterxmlJacksonCoreTokenStreamContext *context, jboolean includeRoot);
