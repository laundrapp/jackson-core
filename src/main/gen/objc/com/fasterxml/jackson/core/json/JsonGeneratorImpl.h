...
FOUNDATION_EXPORT void ComFasterxmlJacksonCoreJsonJsonGeneratorImpl_initWithComFasterxmlJacksonCoreIoIOContext_withInt_withComFasterxmlJacksonCoreObjectCodec_(ComFasterxmlJacksonCoreJsonJsonGeneratorImpl *self, ComFasterxmlJacksonCoreIoIOContext *ctxt, jint features, ComFasterxmlJacksonCoreObjectCodec *codec);
