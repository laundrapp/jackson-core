...
/*!
 @since 2.7 to replace misspelled <code>isUknownVersion()</code>
 */
...
FOUNDATION_EXPORT void ComFasterxmlJacksonCoreVersion_initWithInt_withInt_withInt_withNSString_(ComFasterxmlJacksonCoreVersion *self, jint major, jint minor, jint patchLevel, NSString *snapshotInfo);

FOUNDATION_EXPORT ComFasterxmlJacksonCoreVersion *new_ComFasterxmlJacksonCoreVersion_initWithInt_withInt_withInt_withNSString_(jint major, jint minor, jint patchLevel, NSString *snapshotInfo) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComFasterxmlJacksonCoreVersion *create_ComFasterxmlJacksonCoreVersion_initWithInt_withInt_withInt_withNSString_(jint major, jint minor, jint patchLevel, NSString *snapshotInfo);
