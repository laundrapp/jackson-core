...
- (void)setCodecWithComFasterxmlJacksonCoreObjectCodec:(ComFasterxmlJacksonCoreObjectCodec *)c {
  @throw create_JavaLangUnsupportedOperationException_initWithNSString_(@"Can not use ObjectMapper with non-blocking parser");
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LNSString;", 0x14, 6, 7, -1, -1, -1, -1 },
    { NULL, "I", 0x1, 8, 9, 5, -1, -1, -1 },
    { NULL, "LNSString;", 0x1, -1, -1, 5, -1, -1, -1 },
    { NULL, "LNSString;", 0x1, 10, 11, 5, -1, -1, -1 },
    { NULL, "[C", 0x1, -1, -1, 5, -1, -1, -1 },
    { NULL, "I", 0x1, -1, -1, 5, -1, -1, -1 },
    { NULL, "I", 0x1, -1, -1, 5, -1, -1, -1 },
    { NULL, "[B", 0x1, 12, 13, 5, -1, -1, -1 },
    { NULL, "I", 0x1, 14, 15, 5, -1, -1, -1 },
    { NULL, "LNSObject;", 0x1, -1, -1, 5, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x14, -1, -1, 5, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x14, -1, -1, 5, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x14, -1, -1, 5, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x14, -1, -1, 5, -1, -1, -1 },
    { NULL, "LNSString;", 0x14, 16, 17, 18, -1, -1, -1 },
    { NULL, "LNSString;", 0x14, 16, 19, 18, -1, -1, -1 },
    { NULL, "LNSString;", 0x14, 16, 20, 18, -1, -1, -1 },
    { NULL, "LNSString;", 0x14, 21, 22, 18, -1, -1, -1 },
    { NULL, "I", 0x1c, 23, 17, -1, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x14, -1, -1, 5, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x14, 24, 11, 5, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x14, 25, 7, 5, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x14, 26, 27, 5, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x14, 28, 29, 5, -1, -1, -1 },
    { NULL, "LNSString;", 0x14, 30, 29, -1, -1, -1, -1 },
    { NULL, "V", 0x14, -1, -1, -1, -1, -1, -1 },
    { NULL, "V", 0x4, 31, 29, 18, -1, -1, -1 },
    { NULL, "V", 0x4, 32, 29, 18, -1, -1, -1 },
    { NULL, "V", 0x4, 33, 17, 18, -1, -1, -1 },
    { NULL, "V", 0x4, 33, 29, 18, -1, -1, -1 },
  };
  ...
  methods[3].selector = @selector(canParseAsync);
  methods[4].selector = @selector(symbolTableForTests);
  methods[5].selector = @selector(releaseBufferedWithJavaIoOutputStream:);
  methods[6].selector = @selector(_releaseBuffers);
  methods[7].selector = @selector(getInputSource);
  methods[8].selector = @selector(_closeInput);
  methods[9].selector = @selector(hasTextCharacters);
  ...
  methods[14].selector = @selector(getTextWithJavaIoWriter:);
  methods[15].selector = @selector(getValueAsString);
  methods[16].selector = @selector(getValueAsStringWithNSString:);
  ...
  methods[22].selector = @selector(getEmbeddedObject);
  methods[23].selector = @selector(_startArrayScope);
  methods[24].selector = @selector(_startObjectScope);
  methods[25].selector = @selector(_closeArrayScope);
  methods[26].selector = @selector(_closeObjectScope);
  methods[27].selector = @selector(_findNameWithInt:withInt:);
  methods[28].selector = @selector(_findNameWithInt:withInt:withInt:);
  methods[29].selector = @selector(_findNameWithInt:withInt:withInt:withInt:);
  methods[30].selector = @selector(_addNameWithIntArray:withInt:withInt:);
  methods[31].selector = @selector(_padLastQuadWithInt:withInt:);
  methods[32].selector = @selector(_eofAsNextToken);
  methods[33].selector = @selector(_fieldCompleteWithNSString:);
  methods[34].selector = @selector(_valueCompleteWithComFasterxmlJacksonCoreJsonToken:);
  methods[35].selector = @selector(_valueCompleteIntWithInt:withNSString:);
  methods[36].selector = @selector(_valueNonStdNumberCompleteWithInt:);
  methods[37].selector = @selector(_nonStdTokenWithInt:);
  methods[38].selector = @selector(_updateTokenLocation);
  methods[39].selector = @selector(_reportInvalidCharWithInt:);
  methods[40].selector = @selector(_reportInvalidInitialWithInt:);
  methods[41].selector = @selector(_reportInvalidOtherWithInt:withInt:);
  methods[42].selector = @selector(_reportInvalidOtherWithInt:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "NON_STD_TOKENS", "[LNSString;", .constantValue.asLong = 0, 0x1c, -1, 34, -1, -1 },
    { "NON_STD_TOKEN_VALUES", "[D", .constantValue.asLong = 0, 0x1c, -1, 35, -1, -1 },
...
void ComFasterxmlJacksonCoreJsonAsyncNonBlockingJsonParserBase_initWithComFasterxmlJacksonCoreIoIOContext_withInt_withComFasterxmlJacksonCoreSymByteQuadsCanonicalizer_(ComFasterxmlJacksonCoreJsonAsyncNonBlockingJsonParserBase *self, ComFasterxmlJacksonCoreIoIOContext *ctxt, jint parserFeatures, ComFasterxmlJacksonCoreSymByteQuadsCanonicalizer *sym) {
  ComFasterxmlJacksonCoreBaseParserBase_initWithComFasterxmlJacksonCoreIoIOContext_withInt_(self, ctxt, parserFeatures);
