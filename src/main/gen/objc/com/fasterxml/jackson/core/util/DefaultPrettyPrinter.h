...
inline ComFasterxmlJacksonCoreUtilDefaultPrettyPrinter_NopIndenter *ComFasterxmlJacksonCoreUtilDefaultPrettyPrinter_NopIndenter_get_instance(void);
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT ComFasterxmlJacksonCoreUtilDefaultPrettyPrinter_NopIndenter *ComFasterxmlJacksonCoreUtilDefaultPrettyPrinter_NopIndenter_instance;
J2OBJC_STATIC_FIELD_OBJ_FINAL(ComFasterxmlJacksonCoreUtilDefaultPrettyPrinter_NopIndenter, instance, ComFasterxmlJacksonCoreUtilDefaultPrettyPrinter_NopIndenter *)
...
inline ComFasterxmlJacksonCoreUtilDefaultPrettyPrinter_FixedSpaceIndenter *ComFasterxmlJacksonCoreUtilDefaultPrettyPrinter_FixedSpaceIndenter_get_instance(void);
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT ComFasterxmlJacksonCoreUtilDefaultPrettyPrinter_FixedSpaceIndenter *ComFasterxmlJacksonCoreUtilDefaultPrettyPrinter_FixedSpaceIndenter_instance;
J2OBJC_STATIC_FIELD_OBJ_FINAL(ComFasterxmlJacksonCoreUtilDefaultPrettyPrinter_FixedSpaceIndenter, instance, ComFasterxmlJacksonCoreUtilDefaultPrettyPrinter_FixedSpaceIndenter *)
