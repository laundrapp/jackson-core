...
__attribute__((unused)) static IOSObjectArray *ComFasterxmlJacksonCoreJsonReaderBasedJsonParser__Annotations$0(void);
...
- (instancetype __nonnull)initWithComFasterxmlJacksonCoreIoIOContext:(ComFasterxmlJacksonCoreIoIOContext *)ctxt
  ...
  ComFasterxmlJacksonCoreJsonReaderBasedJsonParser_initWithComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoReader_withComFasterxmlJacksonCoreObjectCodec_withComFasterxmlJacksonCoreSymCharsToNameCanonicalizer_withCharArray_withInt_withInt_withBoolean_(self, ctxt, features, r, codec, st, inputBuffer, start, end, bufferRecyclable);
  return self;
}
...
- (instancetype __nonnull)initWithComFasterxmlJacksonCoreIoIOContext:(ComFasterxmlJacksonCoreIoIOContext *)ctxt
                              ...
                              withComFasterxmlJacksonCoreObjectCodec:(ComFasterxmlJacksonCoreObjectCodec *)codec
              withComFasterxmlJacksonCoreSymCharsToNameCanonicalizer:(ComFasterxmlJacksonCoreSymCharsToNameCanonicalizer *)st {
  ComFasterxmlJacksonCoreJsonReaderBasedJsonParser_initWithComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoReader_withComFasterxmlJacksonCoreObjectCodec_withComFasterxmlJacksonCoreSymCharsToNameCanonicalizer_(self, ctxt, features, r, codec, st);
  return self;
}
...
- (jchar)getNextCharWithNSString:(NSString *)eofMsg {
  return [self getNextCharWithNSString:eofMsg withComFasterxmlJacksonCoreJsonToken:nil];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "C", 0x4, 7, 8, 6, -1, 9, -1 },
    { NULL, "C", 0x4, 7, 10, 6, -1, -1, -1 },
    { NULL, "V", 0x4, -1, -1, 6, -1, -1, -1 },
    { NULL, "V", 0x4, -1, -1, 6, -1, -1, -1 },
    { NULL, "V", 0x4, -1, -1, 6, -1, -1, -1 },
    { NULL, "Z", 0x4, -1, -1, 6, -1, -1, -1 },
    { NULL, "LNSString;", 0x11, -1, -1, 6, -1, -1, -1 },
    { NULL, "I", 0x1, 11, 5, 6, -1, -1, -1 },
    { NULL, "LNSString;", 0x11, -1, -1, 6, -1, -1, -1 },
    { NULL, "LNSString;", 0x11, 12, 8, 6, -1, -1, -1 },
    { NULL, "LNSString;", 0x14, 13, 14, -1, -1, -1, -1 },
    { NULL, "[C", 0x11, -1, -1, 6, -1, -1, -1 },
    { NULL, "I", 0x11, -1, -1, 6, -1, -1, -1 },
    { NULL, "I", 0x11, -1, -1, 6, -1, -1, -1 },
    { NULL, "[B", 0x1, 15, 16, 6, -1, -1, -1 },
    { NULL, "I", 0x1, 17, 18, 6, -1, -1, -1 },
    { NULL, "I", 0x4, 19, 20, 6, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x11, -1, -1, 6, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x12, -1, -1, -1, -1, -1, -1 },
    { NULL, "V", 0x1, -1, -1, 6, -1, -1, -1 },
    { NULL, "Z", 0x1, 21, 22, 6, -1, -1, -1 },
    { NULL, "LNSString;", 0x1, -1, -1, 6, -1, -1, -1 },
    { NULL, "V", 0x12, 23, 24, 6, -1, -1, -1 },
    { NULL, "Z", 0x4, 25, 26, 6, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x12, 27, 24, 6, -1, -1, -1 },
    { NULL, "LNSString;", 0x11, -1, -1, 6, -1, -1, -1 },
    { NULL, "I", 0x11, 28, 24, 6, -1, -1, -1 },
    { NULL, "J", 0x11, 29, 30, 6, -1, -1, -1 },
    { NULL, "LJavaLangBoolean;", 0x11, -1, -1, 6, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x14, 31, 24, 6, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x12, 32, 33, 6, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x14, -1, -1, 6, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x12, 34, 35, 6, -1, -1, -1 },
    { NULL, "C", 0x12, -1, -1, 6, -1, -1, -1 },
    { NULL, "C", 0x2, -1, -1, 6, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x4, 36, 37, 6, -1, -1, -1 },
    { NULL, "V", 0x12, 38, 24, 6, -1, -1, -1 },
    { NULL, "LNSString;", 0x14, -1, -1, 6, -1, -1, -1 },
    { NULL, "LNSString;", 0x2, 39, 40, 6, -1, -1, -1 },
    { NULL, "LNSString;", 0x4, 41, 24, 6, -1, -1, -1 },
    { NULL, "LNSString;", 0x4, -1, -1, 6, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x4, 42, 24, 6, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x4, -1, -1, 6, -1, -1, -1 },
    { NULL, "LNSString;", 0x2, 43, 44, 6, -1, -1, -1 },
    { NULL, "V", 0x14, -1, -1, 6, -1, -1, -1 },
    { NULL, "V", 0x4, -1, -1, 6, -1, -1, -1 },
    { NULL, "V", 0x14, -1, -1, 6, -1, -1, -1 },
    { NULL, "V", 0x14, -1, -1, 6, -1, -1, -1 },
    { NULL, "I", 0x12, -1, -1, 6, -1, -1, -1 },
    { NULL, "I", 0x12, 45, 46, 6, -1, -1, -1 },
    { NULL, "I", 0x12, 47, 24, 6, -1, -1, -1 },
    { NULL, "I", 0x12, 48, 24, 6, -1, -1, -1 },
    { NULL, "I", 0x12, -1, -1, 6, -1, -1, -1 },
    { NULL, "I", 0x12, -1, -1, 6, -1, -1, -1 },
    { NULL, "I", 0x2, -1, -1, 6, -1, -1, -1 },
    { NULL, "V", 0x2, -1, -1, 6, -1, -1, -1 },
    { NULL, "V", 0x2, -1, -1, 6, -1, -1, -1 },
    { NULL, "Z", 0x2, -1, -1, 6, -1, -1, -1 },
    { NULL, "V", 0x2, -1, -1, 6, -1, -1, -1 },
    { NULL, "C", 0x4, -1, -1, 6, -1, -1, -1 },
    { NULL, "V", 0x12, -1, -1, 6, -1, -1, -1 },
    { NULL, "V", 0x12, -1, -1, 6, -1, -1, -1 },
    { NULL, "V", 0x12, -1, -1, 6, -1, -1, -1 },
    { NULL, "V", 0x14, 49, 50, 6, -1, -1, -1 },
    { NULL, "V", 0x12, 51, 50, 6, -1, -1, -1 },
    { NULL, "V", 0x12, 52, 53, 6, -1, -1, -1 },
    { NULL, "[B", 0x4, 54, 16, 6, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonLocation;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonLocation;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "V", 0x12, -1, -1, -1, -1, -1, -1 },
    { NULL, "V", 0x12, -1, -1, -1, -1, -1, -1 },
    { NULL, "V", 0x4, 55, 8, 6, -1, -1, -1 },
    { NULL, "V", 0x4, 55, 56, 6, -1, -1, -1 },
    { NULL, "V", 0x2, 57, 24, 58, -1, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  #pragma clang diagnostic ignored "-Wundeclared-selector"
  methods[0].selector = @selector(initWithComFasterxmlJacksonCoreIoIOContext:withInt:withJavaIoReader:withComFasterxmlJacksonCoreObjectCodec:withComFasterxmlJacksonCoreSymCharsToNameCanonicalizer:withCharArray:withInt:withInt:withBoolean:);
  methods[1].selector = @selector(initWithComFasterxmlJacksonCoreIoIOContext:withInt:withJavaIoReader:withComFasterxmlJacksonCoreObjectCodec:withComFasterxmlJacksonCoreSymCharsToNameCanonicalizer:);
  methods[2].selector = @selector(getCodec);
  methods[3].selector = @selector(setCodecWithComFasterxmlJacksonCoreObjectCodec:);
  methods[4].selector = @selector(releaseBufferedWithJavaIoWriter:);
  methods[5].selector = @selector(getInputSource);
  methods[6].selector = @selector(getNextCharWithNSString:);
  methods[7].selector = @selector(getNextCharWithNSString:withComFasterxmlJacksonCoreJsonToken:);
  methods[8].selector = @selector(_closeInput);
  methods[9].selector = @selector(_releaseBuffers);
  methods[10].selector = @selector(_loadMoreGuaranteed);
  methods[11].selector = @selector(_loadMore);
  methods[12].selector = @selector(getText);
  methods[13].selector = @selector(getTextWithJavaIoWriter:);
  methods[14].selector = @selector(getValueAsString);
  methods[15].selector = @selector(getValueAsStringWithNSString:);
  methods[16].selector = @selector(_getText2WithComFasterxmlJacksonCoreJsonToken:);
  ...
  methods[20].selector = @selector(getBinaryValueWithComFasterxmlJacksonCoreBase64Variant:);
  methods[21].selector = @selector(readBinaryValueWithComFasterxmlJacksonCoreBase64Variant:withJavaIoOutputStream:);
  methods[22].selector = @selector(_readBinaryWithComFasterxmlJacksonCoreBase64Variant:withJavaIoOutputStream:withByteArray:);
  methods[23].selector = @selector(nextToken);
  methods[24].selector = @selector(_nextAfterName);
  methods[25].selector = @selector(finishToken);
  methods[26].selector = @selector(nextFieldNameWithComFasterxmlJacksonCoreSerializableString:);
  methods[27].selector = @selector(nextFieldName);
  methods[28].selector = @selector(_isNextTokenNameYesWithInt:);
  methods[29].selector = @selector(_isNextTokenNameMaybeWithInt:withNSString:);
  methods[30].selector = @selector(_nextTokenNotInObjectWithInt:);
  methods[31].selector = @selector(nextTextValue);
  methods[32].selector = @selector(nextIntValueWithInt:);
  methods[33].selector = @selector(nextLongValueWithLong:);
  methods[34].selector = @selector(nextBooleanValue);
  methods[35].selector = @selector(_parsePosNumberWithInt:);
  methods[36].selector = @selector(_parseFloatWithInt:withInt:withInt:withBoolean:withInt:);
  methods[37].selector = @selector(_parseNegNumber);
  methods[38].selector = @selector(_parseNumber2WithBoolean:withInt:);
  methods[39].selector = @selector(_verifyNoLeadingZeroes);
  methods[40].selector = @selector(_verifyNLZ2);
  methods[41].selector = @selector(_handleInvalidNumberStartWithInt:withBoolean:);
  methods[42].selector = @selector(_verifyRootSpaceWithInt:);
  methods[43].selector = @selector(_parseName);
  methods[44].selector = @selector(_parseName2WithInt:withInt:withInt:);
  methods[45].selector = @selector(_handleOddNameWithInt:);
  methods[46].selector = @selector(_parseAposName);
  methods[47].selector = @selector(_handleOddValueWithInt:);
  methods[48].selector = @selector(_handleApos);
  methods[49].selector = @selector(_handleOddName2WithInt:withInt:withIntArray:);
  methods[50].selector = @selector(_finishString);
  methods[51].selector = @selector(_finishString2);
  methods[52].selector = @selector(_skipString);
  methods[53].selector = @selector(_skipCR);
  methods[54].selector = @selector(_skipColon);
  methods[55].selector = @selector(_skipColon2WithBoolean:);
  methods[56].selector = @selector(_skipColonFastWithInt:);
  methods[57].selector = @selector(_skipCommaWithInt:);
  methods[58].selector = @selector(_skipAfterComma2);
  methods[59].selector = @selector(_skipWSOrEnd);
  methods[60].selector = @selector(_skipWSOrEnd2);
  ...
  methods[66].selector = @selector(_matchTrue);
  methods[67].selector = @selector(_matchFalse);
  methods[68].selector = @selector(_matchNull);
  methods[69].selector = @selector(_matchTokenWithNSString:withInt:);
  methods[70].selector = @selector(_matchToken2WithNSString:withInt:);
  methods[71].selector = @selector(_checkMatchEndWithNSString:withInt:withInt:);
  methods[72].selector = @selector(_decodeBase64WithComFasterxmlJacksonCoreBase64Variant:);
  methods[73].selector = @selector(getTokenLocation);
  methods[74].selector = @selector(getCurrentLocation);
  methods[75].selector = @selector(_updateLocation);
  methods[76].selector = @selector(_updateNameLocation);
  methods[77].selector = @selector(_reportInvalidTokenWithNSString:);
  methods[78].selector = @selector(_reportInvalidTokenWithNSString:withNSString:);
  methods[79].selector = @selector(_closeScopeWithInt:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "FEAT_MASK_TRAILING_COMMA", "I", .constantValue.asLong = 0, 0x1c, -1, 59, -1, -1 },
    { "_icLatin1", "[I", .constantValue.asLong = 0, 0x1c, -1, 60, -1, -1 },
  ...
  static const void *ptrTable[] = { "LComFasterxmlJacksonCoreIoIOContext;ILJavaIoReader;LComFasterxmlJacksonCoreObjectCodec;LComFasterxmlJacksonCoreSymCharsToNameCanonicalizer;[CIIZ", "LComFasterxmlJacksonCoreIoIOContext;ILJavaIoReader;LComFasterxmlJacksonCoreObjectCodec;LComFasterxmlJacksonCoreSymCharsToNameCanonicalizer;", "setCodec", "LComFasterxmlJacksonCoreObjectCodec;", "releaseBuffered", "LJavaIoWriter;", "LJavaIoIOException;", "getNextChar", "LNSString;", (void *)&ComFasterxmlJacksonCoreJsonReaderBasedJsonParser__Annotations$0, "LNSString;LComFasterxmlJacksonCoreJsonToken;", "getText", "getValueAsString", "_getText2", "LComFasterxmlJacksonCoreJsonToken;", "getBinaryValue", "LComFasterxmlJacksonCoreBase64Variant;", "readBinaryValue", "LComFasterxmlJacksonCoreBase64Variant;LJavaIoOutputStream;", "_readBinary", "LComFasterxmlJacksonCoreBase64Variant;LJavaIoOutputStream;[B", "nextFieldName", "LComFasterxmlJacksonCoreSerializableString;", "_isNextTokenNameYes", "I", "_isNextTokenNameMaybe", "ILNSString;", "_nextTokenNotInObject", "nextIntValue", "nextLongValue", "J", "_parsePosNumber", "_parseFloat", "IIIZI", "_parseNumber2", "ZI", "_handleInvalidNumberStart", "IZ", "_verifyRootSpace", "_parseName2", "III", "_handleOddName", "_handleOddValue", "_handleOddName2", "II[I", "_skipColon2", "Z", "_skipColonFast", "_skipComma", "_matchToken", "LNSString;I", "_matchToken2", "_checkMatchEnd", "LNSString;II", "_decodeBase64", "_reportInvalidToken", "LNSString;LNSString;", "_closeScope", "LComFasterxmlJacksonCoreJsonParseException;", &ComFasterxmlJacksonCoreJsonReaderBasedJsonParser_FEAT_MASK_TRAILING_COMMA, &ComFasterxmlJacksonCoreJsonReaderBasedJsonParser__icLatin1 };
  static const J2ObjcClassInfo _ComFasterxmlJacksonCoreJsonReaderBasedJsonParser = { "ReaderBasedJsonParser", "com.fasterxml.jackson.core.json", ptrTable, methods, fields, 7, 0x1, 80, 12, -1, -1, -1, -1, -1 };
...
void ComFasterxmlJacksonCoreJsonReaderBasedJsonParser_initWithComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoReader_withComFasterxmlJacksonCoreObjectCodec_withComFasterxmlJacksonCoreSymCharsToNameCanonicalizer_withCharArray_withInt_withInt_withBoolean_(ComFasterxmlJacksonCoreJsonReaderBasedJsonParser *self, ComFasterxmlJacksonCoreIoIOContext *ctxt, jint features, JavaIoReader *r, ComFasterxmlJacksonCoreObjectCodec *codec, ComFasterxmlJacksonCoreSymCharsToNameCanonicalizer *st, IOSCharArray *inputBuffer, jint start, jint end, jboolean bufferRecyclable) {
...
ComFasterxmlJacksonCoreJsonReaderBasedJsonParser *new_ComFasterxmlJacksonCoreJsonReaderBasedJsonParser_initWithComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoReader_withComFasterxmlJacksonCoreObjectCodec_withComFasterxmlJacksonCoreSymCharsToNameCanonicalizer_withCharArray_withInt_withInt_withBoolean_(ComFasterxmlJacksonCoreIoIOContext *ctxt, jint features, JavaIoReader *r, ComFasterxmlJacksonCoreObjectCodec *codec, ComFasterxmlJacksonCoreSymCharsToNameCanonicalizer *st, IOSCharArray *inputBuffer, jint start, jint end, jboolean bufferRecyclable) {
  J2OBJC_NEW_IMPL(ComFasterxmlJacksonCoreJsonReaderBasedJsonParser, initWithComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoReader_withComFasterxmlJacksonCoreObjectCodec_withComFasterxmlJacksonCoreSymCharsToNameCanonicalizer_withCharArray_withInt_withInt_withBoolean_, ctxt, features, r, codec, st, inputBuffer, start, end, bufferRecyclable)
}

ComFasterxmlJacksonCoreJsonReaderBasedJsonParser *create_ComFasterxmlJacksonCoreJsonReaderBasedJsonParser_initWithComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoReader_withComFasterxmlJacksonCoreObjectCodec_withComFasterxmlJacksonCoreSymCharsToNameCanonicalizer_withCharArray_withInt_withInt_withBoolean_(ComFasterxmlJacksonCoreIoIOContext *ctxt, jint features, JavaIoReader *r, ComFasterxmlJacksonCoreObjectCodec *codec, ComFasterxmlJacksonCoreSymCharsToNameCanonicalizer *st, IOSCharArray *inputBuffer, jint start, jint end, jboolean bufferRecyclable) {
  J2OBJC_CREATE_IMPL(ComFasterxmlJacksonCoreJsonReaderBasedJsonParser, initWithComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoReader_withComFasterxmlJacksonCoreObjectCodec_withComFasterxmlJacksonCoreSymCharsToNameCanonicalizer_withCharArray_withInt_withInt_withBoolean_, ctxt, features, r, codec, st, inputBuffer, start, end, bufferRecyclable)
}

void ComFasterxmlJacksonCoreJsonReaderBasedJsonParser_initWithComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoReader_withComFasterxmlJacksonCoreObjectCodec_withComFasterxmlJacksonCoreSymCharsToNameCanonicalizer_(ComFasterxmlJacksonCoreJsonReaderBasedJsonParser *self, ComFasterxmlJacksonCoreIoIOContext *ctxt, jint features, JavaIoReader *r, ComFasterxmlJacksonCoreObjectCodec *codec, ComFasterxmlJacksonCoreSymCharsToNameCanonicalizer *st) {
  ComFasterxmlJacksonCoreBaseParserBase_initWithComFasterxmlJacksonCoreIoIOContext_withInt_(self, ctxt, features);
  JreStrongAssign(&self->_reader_, r);
...
ComFasterxmlJacksonCoreJsonReaderBasedJsonParser *new_ComFasterxmlJacksonCoreJsonReaderBasedJsonParser_initWithComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoReader_withComFasterxmlJacksonCoreObjectCodec_withComFasterxmlJacksonCoreSymCharsToNameCanonicalizer_(ComFasterxmlJacksonCoreIoIOContext *ctxt, jint features, JavaIoReader *r, ComFasterxmlJacksonCoreObjectCodec *codec, ComFasterxmlJacksonCoreSymCharsToNameCanonicalizer *st) {
  J2OBJC_NEW_IMPL(ComFasterxmlJacksonCoreJsonReaderBasedJsonParser, initWithComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoReader_withComFasterxmlJacksonCoreObjectCodec_withComFasterxmlJacksonCoreSymCharsToNameCanonicalizer_, ctxt, features, r, codec, st)
}

ComFasterxmlJacksonCoreJsonReaderBasedJsonParser *create_ComFasterxmlJacksonCoreJsonReaderBasedJsonParser_initWithComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoReader_withComFasterxmlJacksonCoreObjectCodec_withComFasterxmlJacksonCoreSymCharsToNameCanonicalizer_(ComFasterxmlJacksonCoreIoIOContext *ctxt, jint features, JavaIoReader *r, ComFasterxmlJacksonCoreObjectCodec *codec, ComFasterxmlJacksonCoreSymCharsToNameCanonicalizer *st) {
  J2OBJC_CREATE_IMPL(ComFasterxmlJacksonCoreJsonReaderBasedJsonParser, initWithComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoReader_withComFasterxmlJacksonCoreObjectCodec_withComFasterxmlJacksonCoreSymCharsToNameCanonicalizer_, ctxt, features, r, codec, st)
}
...
ComFasterxmlJacksonCoreJsonToken *ComFasterxmlJacksonCoreJsonReaderBasedJsonParser__parseNumber2WithBoolean_withInt_(ComFasterxmlJacksonCoreJsonReaderBasedJsonParser *self, jboolean neg, jint startPtr) {
  ...
  if (c == 'e' || c == 'E') {
    ...
    *IOSCharArray_GetRef(nil_chk(outBuf), outPtr++) = c;
    c = (self->_inputPtr_ < self->_inputEnd_) ? IOSCharArray_Get(nil_chk(self->_inputBuffer_), self->_inputPtr_++) : [self getNextCharWithNSString:@"expected a digit for number exponent"];
    if (c == '-' || c == '+') {
      if (outPtr >= outBuf->size_) {
        outBuf = [self->_textBuffer_ finishCurrentSegment];
        outPtr = 0;
...
IOSObjectArray *ComFasterxmlJacksonCoreJsonReaderBasedJsonParser__Annotations$0() {
