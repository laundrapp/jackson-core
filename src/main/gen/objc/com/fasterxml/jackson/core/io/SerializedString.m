...
- (IOSCharArray *)asQuotedChars {
  ...
  if (result == nil) {
    result = [((ComFasterxmlJacksonCoreIoJsonStringEncoder *) nil_chk(ComFasterxmlJacksonCoreUtilBufferRecyclers_getJsonStringEncoder())) quoteAsStringWithNSString:_value_];
...
- (IOSByteArray *)asUnquotedUTF8 {
  ...
  if (result == nil) {
    result = [((ComFasterxmlJacksonCoreIoJsonStringEncoder *) nil_chk(ComFasterxmlJacksonCoreUtilBufferRecyclers_getJsonStringEncoder())) encodeAsUTF8WithNSString:_value_];
...
- (IOSByteArray *)asQuotedUTF8 {
  ...
  if (result == nil) {
    result = [((ComFasterxmlJacksonCoreIoJsonStringEncoder *) nil_chk(ComFasterxmlJacksonCoreUtilBufferRecyclers_getJsonStringEncoder())) quoteAsUTF8WithNSString:_value_];
