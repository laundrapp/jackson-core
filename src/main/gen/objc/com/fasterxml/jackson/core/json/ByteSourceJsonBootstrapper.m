...
+ (ComFasterxmlJacksonCoreFormatMatchStrength *)tryMatchWithComFasterxmlJacksonCoreFormatInputAccessor:(id<ComFasterxmlJacksonCoreFormatInputAccessor>)acc
                                                                                          withNSString:(NSString *)matchStr
                                                        withComFasterxmlJacksonCoreFormatMatchStrength:(ComFasterxmlJacksonCoreFormatMatchStrength *)fullMatchStrength;

+ (jint)skipSpaceWithComFasterxmlJacksonCoreFormatInputAccessor:(id<ComFasterxmlJacksonCoreFormatInputAccessor>)acc;
...
__attribute__((unused)) static ComFasterxmlJacksonCoreFormatMatchStrength *ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_tryMatchWithComFasterxmlJacksonCoreFormatInputAccessor_withNSString_withComFasterxmlJacksonCoreFormatMatchStrength_(id<ComFasterxmlJacksonCoreFormatInputAccessor> acc, NSString *matchStr, ComFasterxmlJacksonCoreFormatMatchStrength *fullMatchStrength);

__attribute__((unused)) static jint ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_skipSpaceWithComFasterxmlJacksonCoreFormatInputAccessor_(id<ComFasterxmlJacksonCoreFormatInputAccessor> acc);

__attribute__((unused)) static jint ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_skipSpaceWithComFasterxmlJacksonCoreFormatInputAccessor_withByte_(id<ComFasterxmlJacksonCoreFormatInputAccessor> acc, jbyte b);
...
+ (ComFasterxmlJacksonCoreFormatMatchStrength *)tryMatchWithComFasterxmlJacksonCoreFormatInputAccessor:(id<ComFasterxmlJacksonCoreFormatInputAccessor>)acc
                                                                                          withNSString:(NSString *)matchStr
                                                        withComFasterxmlJacksonCoreFormatMatchStrength:(ComFasterxmlJacksonCoreFormatMatchStrength *)fullMatchStrength {
  return ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_tryMatchWithComFasterxmlJacksonCoreFormatInputAccessor_withNSString_withComFasterxmlJacksonCoreFormatMatchStrength_(acc, matchStr, fullMatchStrength);
}

+ (jint)skipSpaceWithComFasterxmlJacksonCoreFormatInputAccessor:(id<ComFasterxmlJacksonCoreFormatInputAccessor>)acc {
  return ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_skipSpaceWithComFasterxmlJacksonCoreFormatInputAccessor_(acc);
}

+ (jint)skipSpaceWithComFasterxmlJacksonCoreFormatInputAccessor:(id<ComFasterxmlJacksonCoreFormatInputAccessor>)acc
                                                       withByte:(jbyte)b {
  return ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_skipSpaceWithComFasterxmlJacksonCoreFormatInputAccessor_withByte_(acc, b);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LComFasterxmlJacksonCoreFormatMatchStrength;", 0x9, 7, 8, 2, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreFormatMatchStrength;", 0xa, 9, 10, 2, -1, -1, -1 },
    { NULL, "I", 0xa, 11, 8, 2, -1, -1, -1 },
    { NULL, "I", 0xa, 11, 12, 2, -1, -1, -1 },
    { NULL, "Z", 0x2, 13, 14, 2, -1, -1, -1 },
    { NULL, "Z", 0x2, 15, 14, 2, -1, -1, -1 },
    { NULL, "Z", 0x2, 16, 14, -1, -1, -1, -1 },
    { NULL, "V", 0x2, 17, 18, 2, -1, -1, -1 },
    { NULL, "Z", 0x4, 19, 14, 2, -1, -1, -1 },
  };
  ...
  methods[5].selector = @selector(constructParserWithInt:withComFasterxmlJacksonCoreObjectCodec:withComFasterxmlJacksonCoreSymByteQuadsCanonicalizer:withComFasterxmlJacksonCoreSymCharsToNameCanonicalizer:withInt:);
  methods[6].selector = @selector(hasJSONFormatWithComFasterxmlJacksonCoreFormatInputAccessor:);
  methods[7].selector = @selector(tryMatchWithComFasterxmlJacksonCoreFormatInputAccessor:withNSString:withComFasterxmlJacksonCoreFormatMatchStrength:);
  methods[8].selector = @selector(skipSpaceWithComFasterxmlJacksonCoreFormatInputAccessor:);
  methods[9].selector = @selector(skipSpaceWithComFasterxmlJacksonCoreFormatInputAccessor:withByte:);
  methods[10].selector = @selector(handleBOMWithInt:);
  methods[11].selector = @selector(checkUTF32WithInt:);
  methods[12].selector = @selector(checkUTF16WithInt:);
  methods[13].selector = @selector(reportWeirdUCS4WithNSString:);
  methods[14].selector = @selector(ensureLoadedWithInt:);
  ...
  static const void *ptrTable[] = { "LComFasterxmlJacksonCoreIoIOContext;LJavaIoInputStream;", "LComFasterxmlJacksonCoreIoIOContext;[BII", "LJavaIoIOException;", "skipUTF8BOM", "LJavaIoDataInput;", "constructParser", "ILComFasterxmlJacksonCoreObjectCodec;LComFasterxmlJacksonCoreSymByteQuadsCanonicalizer;LComFasterxmlJacksonCoreSymCharsToNameCanonicalizer;I", "hasJSONFormat", "LComFasterxmlJacksonCoreFormatInputAccessor;", "tryMatch", "LComFasterxmlJacksonCoreFormatInputAccessor;LNSString;LComFasterxmlJacksonCoreFormatMatchStrength;", "skipSpace", "LComFasterxmlJacksonCoreFormatInputAccessor;B", "handleBOM", "I", "checkUTF32", "checkUTF16", "reportWeirdUCS4", "LNSString;", "ensureLoaded" };
  static const J2ObjcClassInfo _ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper = { "ByteSourceJsonBootstrapper", "com.fasterxml.jackson.core.json", ptrTable, methods, fields, 7, 0x11, 15, 11, -1, -1, -1, -1, -1 };
...
ComFasterxmlJacksonCoreFormatMatchStrength *ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_hasJSONFormatWithComFasterxmlJacksonCoreFormatInputAccessor_(id<ComFasterxmlJacksonCoreFormatInputAccessor> acc) {
  ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_initialize();
  if (![((id<ComFasterxmlJacksonCoreFormatInputAccessor>) nil_chk(acc)) hasMoreBytes]) {
    return JreLoadEnum(ComFasterxmlJacksonCoreFormatMatchStrength, INCONCLUSIVE);
  }
  jbyte b = [acc nextByte];
  if (b == ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_UTF8_BOM_1) {
    if (![acc hasMoreBytes]) {
      return JreLoadEnum(ComFasterxmlJacksonCoreFormatMatchStrength, INCONCLUSIVE);
    }
    if ([acc nextByte] != ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_UTF8_BOM_2) {
      return JreLoadEnum(ComFasterxmlJacksonCoreFormatMatchStrength, NO_MATCH);
    }
    if (![acc hasMoreBytes]) {
      return JreLoadEnum(ComFasterxmlJacksonCoreFormatMatchStrength, INCONCLUSIVE);
    }
    if ([acc nextByte] != ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_UTF8_BOM_3) {
      return JreLoadEnum(ComFasterxmlJacksonCoreFormatMatchStrength, NO_MATCH);
    }
    if (![acc hasMoreBytes]) {
      return JreLoadEnum(ComFasterxmlJacksonCoreFormatMatchStrength, INCONCLUSIVE);
  ...
  jint ch = ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_skipSpaceWithComFasterxmlJacksonCoreFormatInputAccessor_withByte_(acc, b);
  if (ch < 0) {
    return JreLoadEnum(ComFasterxmlJacksonCoreFormatMatchStrength, INCONCLUSIVE);
  }
  if (ch == '{') {
    ch = ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_skipSpaceWithComFasterxmlJacksonCoreFormatInputAccessor_(acc);
    if (ch < 0) {
      return JreLoadEnum(ComFasterxmlJacksonCoreFormatMatchStrength, INCONCLUSIVE);
    }
    if (ch == '"' || ch == '}') {
      return JreLoadEnum(ComFasterxmlJacksonCoreFormatMatchStrength, SOLID_MATCH);
    }
    return JreLoadEnum(ComFasterxmlJacksonCoreFormatMatchStrength, NO_MATCH);
  }
  ComFasterxmlJacksonCoreFormatMatchStrength *strength;
  if (ch == '[') {
    ch = ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_skipSpaceWithComFasterxmlJacksonCoreFormatInputAccessor_(acc);
    if (ch < 0) {
      return JreLoadEnum(ComFasterxmlJacksonCoreFormatMatchStrength, INCONCLUSIVE);
    ...
    strength = JreLoadEnum(ComFasterxmlJacksonCoreFormatMatchStrength, WEAK_MATCH);
  }
  if (ch == '"') {
    return strength;
  }
  ...
  if (ch == '-') {
    ...
    return (ch <= '9' && ch >= '0') ? strength : JreLoadEnum(ComFasterxmlJacksonCoreFormatMatchStrength, NO_MATCH);
  }
  if (ch == 'n') {
    return ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_tryMatchWithComFasterxmlJacksonCoreFormatInputAccessor_withNSString_withComFasterxmlJacksonCoreFormatMatchStrength_(acc, @"ull", strength);
  }
  if (ch == 't') {
    return ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_tryMatchWithComFasterxmlJacksonCoreFormatInputAccessor_withNSString_withComFasterxmlJacksonCoreFormatMatchStrength_(acc, @"rue", strength);
  }
  if (ch == 'f') {
    return ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_tryMatchWithComFasterxmlJacksonCoreFormatInputAccessor_withNSString_withComFasterxmlJacksonCoreFormatMatchStrength_(acc, @"alse", strength);
  }
  return JreLoadEnum(ComFasterxmlJacksonCoreFormatMatchStrength, NO_MATCH);
}

ComFasterxmlJacksonCoreFormatMatchStrength *ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_tryMatchWithComFasterxmlJacksonCoreFormatInputAccessor_withNSString_withComFasterxmlJacksonCoreFormatMatchStrength_(id<ComFasterxmlJacksonCoreFormatInputAccessor> acc, NSString *matchStr, ComFasterxmlJacksonCoreFormatMatchStrength *fullMatchStrength) {
  ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_initialize();
  for (jint i = 0, len = [((NSString *) nil_chk(matchStr)) java_length]; i < len; ++i) {
    if (![((id<ComFasterxmlJacksonCoreFormatInputAccessor>) nil_chk(acc)) hasMoreBytes]) {
      return JreLoadEnum(ComFasterxmlJacksonCoreFormatMatchStrength, INCONCLUSIVE);
    }
    if ([acc nextByte] != [matchStr charAtWithInt:i]) {
      return JreLoadEnum(ComFasterxmlJacksonCoreFormatMatchStrength, NO_MATCH);
    }
  }
...
jint ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_skipSpaceWithComFasterxmlJacksonCoreFormatInputAccessor_(id<ComFasterxmlJacksonCoreFormatInputAccessor> acc) {
  ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_initialize();
  if (![((id<ComFasterxmlJacksonCoreFormatInputAccessor>) nil_chk(acc)) hasMoreBytes]) {
    return -1;
  }
  return ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_skipSpaceWithComFasterxmlJacksonCoreFormatInputAccessor_withByte_(acc, [acc nextByte]);
}

jint ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_skipSpaceWithComFasterxmlJacksonCoreFormatInputAccessor_withByte_(id<ComFasterxmlJacksonCoreFormatInputAccessor> acc, jbyte b) {
  ComFasterxmlJacksonCoreJsonByteSourceJsonBootstrapper_initialize();
  while (true) {
    jint ch = (jint) b & (jint) 0xFF;
    if (!(ch == ' ' || ch == 0x000d || ch == 0x000a || ch == 0x0009)) {
      return ch;
    }
    if (![((id<ComFasterxmlJacksonCoreFormatInputAccessor>) nil_chk(acc)) hasMoreBytes]) {
      return -1;
