...
/*!
 @brief Extension of <code>TokenStreamContext</code>, which implements
  core methods needed, and also exposes
  more complete API to parser implementation classes.
 */
@interface ComFasterxmlJacksonCoreJsonJsonReadContext : ComFasterxmlJacksonCoreTokenStreamContext {
 @public
  /*!
