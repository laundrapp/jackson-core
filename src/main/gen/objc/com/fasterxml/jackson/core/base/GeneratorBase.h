...
@interface ComFasterxmlJacksonCoreBaseGeneratorBase : ComFasterxmlJacksonCoreJsonGenerator {
 @public
  /*!
   @brief Context object used both to pass some initial settings and to allow
  triggering of Object serialization through generator.
   @since 3.0
   */
  id<ComFasterxmlJacksonCoreObjectWriteContext> _objectWriteContext_;
  /*!
 ...
 <code>com.fasterxml.jackson.core.JsonGenerator.Feature</code>).
  ...
  of the generator.
   */
  ComFasterxmlJacksonCoreJsonJsonWriteContext *_outputContext_;
  /*!
...
J2OBJC_FIELD_SETTER(ComFasterxmlJacksonCoreBaseGeneratorBase, _objectWriteContext_, id<ComFasterxmlJacksonCoreObjectWriteContext>)
J2OBJC_FIELD_SETTER(ComFasterxmlJacksonCoreBaseGeneratorBase, _outputContext_, ComFasterxmlJacksonCoreJsonJsonWriteContext *)
...
FOUNDATION_EXPORT void ComFasterxmlJacksonCoreBaseGeneratorBase_initWithComFasterxmlJacksonCoreObjectWriteContext_withInt_(ComFasterxmlJacksonCoreBaseGeneratorBase *self, id<ComFasterxmlJacksonCoreObjectWriteContext> writeCtxt, jint features);
