...
- (instancetype __nonnull)initWithComFasterxmlJacksonCoreObjectReadContext:(id<ComFasterxmlJacksonCoreObjectReadContext>)readCtxt
  ...
  ComFasterxmlJacksonCoreJsonAsyncNonBlockingJsonParser_initWithComFasterxmlJacksonCoreObjectReadContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withComFasterxmlJacksonCoreSymByteQuadsCanonicalizer_(self, readCtxt, ctxt, parserFeatures, sym);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[8].selector = @selector(finishToken);
  methods[9].selector = @selector(_finishToken);
  methods[10].selector = @selector(_finishTokenWithEOF);
  methods[11].selector = @selector(_startDocumentWithInt:);
  methods[12].selector = @selector(_finishBOMWithInt:);
  methods[13].selector = @selector(_startFieldNameWithInt:);
  methods[14].selector = @selector(_startFieldNameAfterCommaWithInt:);
  methods[15].selector = @selector(_startValueWithInt:);
  methods[16].selector = @selector(_startValueExpectCommaWithInt:);
  methods[17].selector = @selector(_startValueExpectColonWithInt:);
  methods[18].selector = @selector(_startValueAfterCommaWithInt:);
  methods[19].selector = @selector(_startUnexpectedValueWithBoolean:withInt:);
  methods[20].selector = @selector(_skipWSWithInt:);
  methods[21].selector = @selector(_startSlashCommentWithInt:);
  methods[22].selector = @selector(_finishHashCommentWithInt:);
  methods[23].selector = @selector(_finishCppCommentWithInt:);
  methods[24].selector = @selector(_finishCCommentWithInt:withBoolean:);
  methods[25].selector = @selector(_startAfterCommentWithInt:);
  methods[26].selector = @selector(_startFalseToken);
  methods[27].selector = @selector(_startTrueToken);
  methods[28].selector = @selector(_startNullToken);
  methods[29].selector = @selector(_finishKeywordTokenWithNSString:withInt:withComFasterxmlJacksonCoreJsonToken:);
  methods[30].selector = @selector(_finishKeywordTokenWithEOFWithNSString:withInt:withComFasterxmlJacksonCoreJsonToken:);
  methods[31].selector = @selector(_finishNonStdTokenWithInt:withInt:);
  methods[32].selector = @selector(_finishNonStdTokenWithEOFWithInt:withInt:);
  methods[33].selector = @selector(_finishErrorToken);
  methods[34].selector = @selector(_finishErrorTokenWithEOF);
  methods[35].selector = @selector(_reportErrorTokenWithNSString:);
  methods[36].selector = @selector(_startPositiveNumberWithInt:);
  methods[37].selector = @selector(_startNegativeNumber);
  methods[38].selector = @selector(_startNumberLeadingZero);
  methods[39].selector = @selector(_finishNumberMinusWithInt:);
  methods[40].selector = @selector(_finishNumberLeadingZeroes);
  methods[41].selector = @selector(_finishNumberLeadingNegZeroes);
  methods[42].selector = @selector(_finishNumberIntegralPartWithCharArray:withInt:);
  methods[43].selector = @selector(_startFloatWithCharArray:withInt:withInt:);
  methods[44].selector = @selector(_finishFloatFraction);
  methods[45].selector = @selector(_finishFloatExponentWithBoolean:withInt:);
  methods[46].selector = @selector(_fastParseName);
  methods[47].selector = @selector(_parseMediumNameWithInt:withInt:);
  methods[48].selector = @selector(_parseMediumName2WithInt:withInt:withInt:);
  methods[49].selector = @selector(_parseEscapedNameWithInt:withInt:withInt:);
  methods[50].selector = @selector(_handleOddNameWithInt:);
  methods[51].selector = @selector(_finishUnquotedNameWithInt:withInt:withInt:);
  methods[52].selector = @selector(_finishAposNameWithInt:withInt:withInt:);
  methods[53].selector = @selector(_finishFieldWithEscape);
  methods[54].selector = @selector(_decodeSplitEscapedWithInt:withInt:);
  methods[55].selector = @selector(_startString);
  methods[56].selector = @selector(_finishRegularString);
  methods[57].selector = @selector(_startAposString);
  methods[58].selector = @selector(_finishAposString);
  methods[59].selector = @selector(_decodeSplitMultiByteWithInt:withInt:withBoolean:);
  methods[60].selector = @selector(_decodeSplitUTF8_3WithInt:withInt:withInt:);
  methods[61].selector = @selector(_decodeSplitUTF8_4WithInt:withInt:withInt:);
  methods[62].selector = @selector(_decodeCharEscape);
  methods[63].selector = @selector(_decodeFastCharEscape);
  methods[64].selector = @selector(_decodeUTF8_2WithInt:withInt:);
  methods[65].selector = @selector(_decodeUTF8_3WithInt:withInt:withInt:);
  methods[66].selector = @selector(_decodeUTF8_4WithInt:withInt:withInt:withInt:);
...
ComFasterxmlJacksonCoreJsonAsyncNonBlockingJsonParser *new_ComFasterxmlJacksonCoreJsonAsyncNonBlockingJsonParser_initWithComFasterxmlJacksonCoreObjectReadContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withComFasterxmlJacksonCoreSymByteQuadsCanonicalizer_(id<ComFasterxmlJacksonCoreObjectReadContext> readCtxt, ComFasterxmlJacksonCoreIoIOContext *ctxt, jint parserFeatures, ComFasterxmlJacksonCoreSymByteQuadsCanonicalizer *sym) {
  J2OBJC_NEW_IMPL(ComFasterxmlJacksonCoreJsonAsyncNonBlockingJsonParser, initWithComFasterxmlJacksonCoreObjectReadContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withComFasterxmlJacksonCoreSymByteQuadsCanonicalizer_, readCtxt, ctxt, parserFeatures, sym)
}

ComFasterxmlJacksonCoreJsonAsyncNonBlockingJsonParser *create_ComFasterxmlJacksonCoreJsonAsyncNonBlockingJsonParser_initWithComFasterxmlJacksonCoreObjectReadContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withComFasterxmlJacksonCoreSymByteQuadsCanonicalizer_(id<ComFasterxmlJacksonCoreObjectReadContext> readCtxt, ComFasterxmlJacksonCoreIoIOContext *ctxt, jint parserFeatures, ComFasterxmlJacksonCoreSymByteQuadsCanonicalizer *sym) {
  J2OBJC_CREATE_IMPL(ComFasterxmlJacksonCoreJsonAsyncNonBlockingJsonParser, initWithComFasterxmlJacksonCoreObjectReadContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withComFasterxmlJacksonCoreSymByteQuadsCanonicalizer_, readCtxt, ctxt, parserFeatures, sym)
}
