...
__attribute__((unused)) static IOSObjectArray *ComFasterxmlJacksonCoreJsonJsonWriteContext__Annotations$0(void);
...
+ (ComFasterxmlJacksonCoreJsonJsonWriteContext *)createRootContext {
  return ComFasterxmlJacksonCoreJsonJsonWriteContext_createRootContext();
}
...
- (ComFasterxmlJacksonCoreJsonJsonWriteContext *)createChildArrayContext {
  ...
  if (ctxt == nil) {
    JreStrongAssign(&_child_, ctxt = create_ComFasterxmlJacksonCoreJsonJsonWriteContext_initWithInt_withComFasterxmlJacksonCoreJsonJsonWriteContext_withComFasterxmlJacksonCoreJsonDupDetector_(ComFasterxmlJacksonCoreJsonStreamContext_TYPE_ARRAY, self, (_dups_ == nil) ? nil : [((ComFasterxmlJacksonCoreJsonDupDetector *) nil_chk(_dups_)) child]));
    return ctxt;
  }
  return [ctxt resetWithInt:ComFasterxmlJacksonCoreJsonStreamContext_TYPE_ARRAY];
}

- (ComFasterxmlJacksonCoreJsonJsonWriteContext *)createChildObjectContext {
  ComFasterxmlJacksonCoreJsonJsonWriteContext *ctxt = _child_;
  if (ctxt == nil) {
    JreStrongAssign(&_child_, ctxt = create_ComFasterxmlJacksonCoreJsonJsonWriteContext_initWithInt_withComFasterxmlJacksonCoreJsonJsonWriteContext_withComFasterxmlJacksonCoreJsonDupDetector_(ComFasterxmlJacksonCoreJsonStreamContext_TYPE_OBJECT, self, (_dups_ == nil) ? nil : [((ComFasterxmlJacksonCoreJsonDupDetector *) nil_chk(_dups_)) child]));
    return ctxt;
  }
  return [ctxt resetWithInt:ComFasterxmlJacksonCoreJsonStreamContext_TYPE_OBJECT];
}
...
- (jint)writeFieldNameWithNSString:(NSString *)name {
  if ((_type_ != ComFasterxmlJacksonCoreJsonStreamContext_TYPE_OBJECT) || _gotName_) {
...
- (jint)writeValue {
  ...
  if (_type_ == ComFasterxmlJacksonCoreJsonStreamContext_TYPE_ARRAY) {
    jint ix = _index_;
    ++_index_;
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LComFasterxmlJacksonCoreJsonJsonWriteContext;", 0x4, 1, 2, -1, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonJsonWriteContext;", 0x1, 3, 4, -1, -1, -1, -1 },
    { NULL, "LNSObject;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "V", 0x1, 5, 6, -1, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonJsonWriteContext;", 0x9, -1, -1, -1, -1, 7, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonJsonWriteContext;", 0x9, 8, 4, -1, -1, -1, -1 },
  ...
  methods[5].selector = @selector(createRootContext);
  ...
  methods[12].selector = @selector(clearAndGetParent);
  methods[13].selector = @selector(getDupDetector);
  methods[14].selector = @selector(writeFieldNameWithNSString:);
  methods[15].selector = @selector(_checkDupWithComFasterxmlJacksonCoreJsonDupDetector:withNSString:);
  methods[16].selector = @selector(writeValue);
  ...
  static const void *ptrTable[] = { "ILComFasterxmlJacksonCoreJsonJsonWriteContext;LComFasterxmlJacksonCoreJsonDupDetector;", "reset", "I", "withDupDetector", "LComFasterxmlJacksonCoreJsonDupDetector;", "setCurrentValue", "LNSObject;", (void *)&ComFasterxmlJacksonCoreJsonJsonWriteContext__Annotations$0, "createRootContext", "writeFieldName", "LNSString;", "LComFasterxmlJacksonCoreJsonProcessingException;", "_checkDup", "LComFasterxmlJacksonCoreJsonDupDetector;LNSString;" };
  static const J2ObjcClassInfo _ComFasterxmlJacksonCoreJsonJsonWriteContext = { "JsonWriteContext", "com.fasterxml.jackson.core.json", ptrTable, methods, fields, 7, 0x1, 17, 12, -1, -1, -1, -1, -1 };
...
ComFasterxmlJacksonCoreJsonJsonWriteContext *ComFasterxmlJacksonCoreJsonJsonWriteContext_createRootContext() {
  ComFasterxmlJacksonCoreJsonJsonWriteContext_initialize();
  return ComFasterxmlJacksonCoreJsonJsonWriteContext_createRootContextWithComFasterxmlJacksonCoreJsonDupDetector_(nil);
}
...
ComFasterxmlJacksonCoreJsonJsonWriteContext *ComFasterxmlJacksonCoreJsonJsonWriteContext_createRootContextWithComFasterxmlJacksonCoreJsonDupDetector_(ComFasterxmlJacksonCoreJsonDupDetector *dd) {
  ComFasterxmlJacksonCoreJsonJsonWriteContext_initialize();
  return create_ComFasterxmlJacksonCoreJsonJsonWriteContext_initWithInt_withComFasterxmlJacksonCoreJsonJsonWriteContext_withComFasterxmlJacksonCoreJsonDupDetector_(ComFasterxmlJacksonCoreJsonStreamContext_TYPE_ROOT, nil, dd);
}
...
IOSObjectArray *ComFasterxmlJacksonCoreJsonJsonWriteContext__Annotations$0() {
