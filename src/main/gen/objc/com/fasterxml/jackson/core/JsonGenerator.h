...
/*!
 @brief Method for accessing custom escapes generator uses for <code>JsonGenerator</code>s
  it creates.
 */
...
/*!
 @brief Accessor for context object that provides information about low-level
...
/*!
 @brief Method for writing given Java object (POJO) as tokens into
...
/*!
 @brief Method for writing given JSON tree (expressed as a tree
  where given <code>TreeNode</code> is the root) using this generator.
 This is done by delegating call to 
 <code>ObjectWriteContext.writeTree</code>.
 */
...
typedef NS_ENUM(NSUInteger, ComFasterxmlJacksonCoreJsonGenerator_Feature_Enum) {
  ...
  ComFasterxmlJacksonCoreJsonGenerator_Feature_Enum_AUTO_CLOSE_CONTENT = 1,
...
/*!
 ...
 <code>JsonToken.START_ARRAY</code> or <code>JsonToken.START_OBJECT</code>
  ...
  specific is done.
 <p>
  NOTE: was named <code>AUTO_CLOSE_JSON_CONTENT</code> in Jackson 2.x.
 <p>
  Feature is enabled by default.
 */
inline ComFasterxmlJacksonCoreJsonGenerator_Feature *ComFasterxmlJacksonCoreJsonGenerator_Feature_get_AUTO_CLOSE_CONTENT(void);
J2OBJC_ENUM_CONSTANT(ComFasterxmlJacksonCoreJsonGenerator_Feature, AUTO_CLOSE_CONTENT)
