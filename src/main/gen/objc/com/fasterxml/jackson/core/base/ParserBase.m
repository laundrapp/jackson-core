...
- (NSString *)currentName {
  ...
  return [((ComFasterxmlJacksonCoreJsonJsonReadContext *) nil_chk(_parsingContext_)) currentName];
}
...
- (void)close {
  if (!_closed_) {
    _inputPtr_ = JavaLangMath_maxWithInt_withInt_(_inputPtr_, _inputEnd_);
    _closed_ = true;
    @try {
      [self _closeInput];
    }
...
- (IOSByteArray *)getBinaryValueWithComFasterxmlJacksonCoreBase64Variant:(ComFasterxmlJacksonCoreBase64Variant *)variant {
  if (_binaryValue_ == nil) {
    if (_currToken_ != JreLoadEnum(ComFasterxmlJacksonCoreJsonToken, VALUE_STRING)) {
      [self _reportErrorWithNSString:@"Current token (%s) not VALUE_EMBEDDED_OBJECT or VALUE_STRING, can not access as binary" withId:_currToken_];
    }
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LComFasterxmlJacksonCoreJsonLocation;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "Z", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "[B", 0x1, 10, 11, 7, -1, -1, -1 },
    { NULL, "J", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "I", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "I", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "V", 0x404, -1, -1, 7, -1, -1, -1 },
    { NULL, "V", 0x4, -1, -1, 7, -1, -1, -1 },
    { NULL, "V", 0x4, -1, -1, 12, -1, -1, -1 },
    { NULL, "I", 0x14, -1, -1, 12, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreUtilByteArrayBuilder;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x14, 13, 14, -1, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x14, 15, 16, -1, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x14, 17, 14, -1, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonToken;", 0x14, 18, 19, -1, -1, -1, -1 },
    { NULL, "Z", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LNSNumber;", 0x1, -1, -1, 7, -1, -1, -1 },
    { NULL, "LComFasterxmlJacksonCoreJsonParser_NumberType;", 0x1, -1, -1, 7, -1, -1, -1 },
    { NULL, "I", 0x1, -1, -1, 7, -1, -1, -1 },
    { NULL, "J", 0x1, -1, -1, 7, -1, -1, -1 },
    { NULL, "LJavaMathBigInteger;", 0x1, -1, -1, 7, -1, -1, -1 },
    { NULL, "F", 0x1, -1, -1, 7, -1, -1, -1 },
    { NULL, "D", 0x1, -1, -1, 7, -1, -1, -1 },
    { NULL, "LJavaMathBigDecimal;", 0x1, -1, -1, 7, -1, -1, -1 },
    { NULL, "V", 0x4, 20, 21, 7, -1, -1, -1 },
    { NULL, "I", 0x4, -1, -1, 7, -1, -1, -1 },
    { NULL, "V", 0x2, 22, 21, 7, -1, -1, -1 },
    { NULL, "V", 0x2, 23, 21, 7, -1, -1, -1 },
    { NULL, "V", 0x4, -1, -1, 7, -1, -1, -1 },
    { NULL, "V", 0x4, -1, -1, 7, -1, -1, -1 },
    { NULL, "V", 0x4, -1, -1, 7, -1, -1, -1 },
    { NULL, "V", 0x4, -1, -1, 7, -1, -1, -1 },
    { NULL, "V", 0x4, -1, -1, 7, -1, -1, -1 },
    { NULL, "V", 0x4, 24, 25, 12, -1, -1, -1 },
    { NULL, "C", 0x4, -1, -1, 7, -1, -1, -1 },
    { NULL, "I", 0x14, 26, 27, 7, -1, -1, -1 },
    { NULL, "I", 0x14, 26, 28, 7, -1, -1, -1 },
    { NULL, "LJavaLangIllegalArgumentException;", 0x4, 29, 27, 30, -1, -1, -1 },
    { NULL, "LJavaLangIllegalArgumentException;", 0x4, 29, 31, 30, -1, -1, -1 },
    { NULL, "LNSObject;", 0x4, -1, -1, -1, -1, -1, -1 },
    { NULL, "[I", 0xc, 32, 33, -1, -1, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  #pragma clang diagnostic ignored "-Wundeclared-selector"
  methods[0].selector = @selector(initWithComFasterxmlJacksonCoreObjectReadContext:withComFasterxmlJacksonCoreIoIOContext:withInt:);
  ...
  methods[6].selector = @selector(currentName);
  methods[7].selector = @selector(overrideCurrentNameWithNSString:);
  methods[8].selector = @selector(close);
  methods[9].selector = @selector(isClosed);
  methods[10].selector = @selector(getParsingContext);
  methods[11].selector = @selector(getTokenLocation);
  methods[12].selector = @selector(getCurrentLocation);
  methods[13].selector = @selector(hasTextCharacters);
  methods[14].selector = @selector(getBinaryValueWithComFasterxmlJacksonCoreBase64Variant:);
  methods[15].selector = @selector(getTokenCharacterOffset);
  methods[16].selector = @selector(getTokenLineNr);
  methods[17].selector = @selector(getTokenColumnNr);
  methods[18].selector = @selector(_closeInput);
  methods[19].selector = @selector(_releaseBuffers);
  methods[20].selector = @selector(_handleEOF);
  methods[21].selector = @selector(_eofAsNextChar);
  methods[22].selector = @selector(_getByteArrayBuilder);
  methods[23].selector = @selector(resetWithBoolean:withInt:withInt:withInt:);
  methods[24].selector = @selector(resetIntWithBoolean:withInt:);
  methods[25].selector = @selector(resetFloatWithBoolean:withInt:withInt:withInt:);
  methods[26].selector = @selector(resetAsNaNWithNSString:withDouble:);
  methods[27].selector = @selector(isNaN);
  methods[28].selector = @selector(getNumberValue);
  methods[29].selector = @selector(getNumberType);
  methods[30].selector = @selector(getIntValue);
  methods[31].selector = @selector(getLongValue);
  methods[32].selector = @selector(getBigIntegerValue);
  methods[33].selector = @selector(getFloatValue);
  methods[34].selector = @selector(getDoubleValue);
  methods[35].selector = @selector(getDecimalValue);
  methods[36].selector = @selector(_parseNumericValueWithInt:);
  methods[37].selector = @selector(_parseIntValue);
  methods[38].selector = @selector(_parseSlowFloatWithInt:);
  methods[39].selector = @selector(_parseSlowIntWithInt:);
  methods[40].selector = @selector(convertNumberToInt);
  methods[41].selector = @selector(convertNumberToLong);
  methods[42].selector = @selector(convertNumberToBigInteger);
  methods[43].selector = @selector(convertNumberToDouble);
  methods[44].selector = @selector(convertNumberToBigDecimal);
  methods[45].selector = @selector(_reportMismatchedEndMarkerWithInt:withChar:);
  methods[46].selector = @selector(_decodeEscaped);
  methods[47].selector = @selector(_decodeBase64EscapeWithComFasterxmlJacksonCoreBase64Variant:withInt:withInt:);
  methods[48].selector = @selector(_decodeBase64EscapeWithComFasterxmlJacksonCoreBase64Variant:withChar:withInt:);
  methods[49].selector = @selector(reportInvalidBase64CharWithComFasterxmlJacksonCoreBase64Variant:withInt:withInt:);
  methods[50].selector = @selector(reportInvalidBase64CharWithComFasterxmlJacksonCoreBase64Variant:withInt:withInt:withNSString:);
  methods[51].selector = @selector(_getSourceReference);
  methods[52].selector = @selector(growArrayByWithIntArray:withInt:);
  ...
  static const void *ptrTable[] = { "LComFasterxmlJacksonCoreObjectReadContext;LComFasterxmlJacksonCoreIoIOContext;I", "version", "setCurrentValue", "LNSObject;", "enable", "LComFasterxmlJacksonCoreJsonParser_Feature;", "disable", "LJavaIoIOException;", "overrideCurrentName", "LNSString;", "getBinaryValue", "LComFasterxmlJacksonCoreBase64Variant;", "LComFasterxmlJacksonCoreJsonParseException;", "reset", "ZIII", "resetInt", "ZI", "resetFloat", "resetAsNaN", "LNSString;D", "_parseNumericValue", "I", "_parseSlowFloat", "_parseSlowInt", "_reportMismatchedEndMarker", "IC", "_decodeBase64Escape", "LComFasterxmlJacksonCoreBase64Variant;II", "LComFasterxmlJacksonCoreBase64Variant;CI", "reportInvalidBase64Char", "LJavaLangIllegalArgumentException;", "LComFasterxmlJacksonCoreBase64Variant;IILNSString;", "growArrayBy", "[II" };
  static const J2ObjcClassInfo _ComFasterxmlJacksonCoreBaseParserBase = { "ParserBase", "com.fasterxml.jackson.core.base", ptrTable, methods, fields, 7, 0x401, 53, 27, -1, -1, -1, -1, -1 };
  return &_ComFasterxmlJacksonCoreBaseParserBase;
}

@end

void ComFasterxmlJacksonCoreBaseParserBase_initWithComFasterxmlJacksonCoreObjectReadContext_withComFasterxmlJacksonCoreIoIOContext_withInt_(ComFasterxmlJacksonCoreBaseParserBase *self, id<ComFasterxmlJacksonCoreObjectReadContext> readCtxt, ComFasterxmlJacksonCoreIoIOContext *ctxt, jint features) {
