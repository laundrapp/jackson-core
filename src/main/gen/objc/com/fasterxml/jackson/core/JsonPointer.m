...
+ (ComFasterxmlJacksonCoreJsonPointer *)forPathWithComFasterxmlJacksonCoreJsonStreamContext:(ComFasterxmlJacksonCoreJsonStreamContext *)context
  ...
  return ComFasterxmlJacksonCoreJsonPointer_forPathWithComFasterxmlJacksonCoreJsonStreamContext_withBoolean_(context, includeRoot);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[5].selector = @selector(forPathWithComFasterxmlJacksonCoreJsonStreamContext:withBoolean:);
...
ComFasterxmlJacksonCoreJsonPointer *ComFasterxmlJacksonCoreJsonPointer_forPathWithComFasterxmlJacksonCoreJsonStreamContext_withBoolean_(ComFasterxmlJacksonCoreJsonStreamContext *context, jboolean includeRoot) {
  ComFasterxmlJacksonCoreJsonPointer_initialize();
  if (context == nil) {
    return ComFasterxmlJacksonCoreJsonPointer_EMPTY;
  }
  ...
  for (; context != nil; context = [context getParent]) {
    if ([context inObject]) {
      NSString *seg = [context getCurrentName];
      if (seg == nil) {
        seg = @"";
      }
