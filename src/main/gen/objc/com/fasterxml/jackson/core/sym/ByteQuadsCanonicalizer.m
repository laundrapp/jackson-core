...
- (ComFasterxmlJacksonCoreSymByteQuadsCanonicalizer *)makeChildWithInt:(jint)flags {
  return create_ComFasterxmlJacksonCoreSymByteQuadsCanonicalizer_initWithComFasterxmlJacksonCoreSymByteQuadsCanonicalizer_withBoolean_withInt_withBoolean_withComFasterxmlJacksonCoreSymByteQuadsCanonicalizer_TableInfo_(self, [((ComFasterxmlJacksonCoreTokenStreamFactory_Feature *) nil_chk(JreLoadEnum(ComFasterxmlJacksonCoreTokenStreamFactory_Feature, INTERN_FIELD_NAMES))) enabledInWithInt:flags], _seed_, [((ComFasterxmlJacksonCoreTokenStreamFactory_Feature *) nil_chk(JreLoadEnum(ComFasterxmlJacksonCoreTokenStreamFactory_Feature, FAIL_ON_SYMBOL_HASH_OVERFLOW))) enabledInWithInt:flags], [((JavaUtilConcurrentAtomicAtomicReference *) nil_chk(_tableInfo_)) get]);
}
