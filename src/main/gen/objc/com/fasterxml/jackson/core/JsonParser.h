...
/*!
 @brief Specialized capability accessor used to check whether parsers for
...
/*!
 ...
 <code>com.fasterxml.jackson.core.json.JsonFactory</code> for details,
  but the general
...
/*!
 @brief Method that verifies that the current token (see <code>currentToken</code> is 
 <code>JsonToken.FIELD_NAME</code> and if so, further match it to one of pre-specified (field) names.
 If match succeeds, field index (non-negative `int`) is returned; otherwise one of
  marker constants from <code>FieldNameMatcher</code>.
 @since 3.0
 */
...
/*!
 @brief Method similar to <code>currentToken()</code> but that returns an 
...
/*!
 @brief Accessor for context object provided by higher-level databinding
...
/*!
 @brief Method that fetches next token (as if calling <code>nextToken</code>) and
  ...
  returns same as <code>currentName()</code>, otherwise null.
 */
- (NSString *)nextFieldName;

/*!
 @brief Method that tries to match next token from stream as <code>JsonToken.FIELD_NAME</code>,
...
/*!
 ...
 Or put another way, nextToken() will be called once,
  ...
  by calling <code>currentName</code> when parser points to
  the value.
...
/*!
 @brief Method to deserialize stream content into a non-container
 ...
 <code>ObjectReadContext</code>; this is true if constructed by
...
/*!
 @brief Method to deserialize stream content into a Java type, reference
...
/*!
 @brief Method to deserialize stream content into equivalent "tree model",
