...
- (instancetype __nonnull)initWithComFasterxmlJacksonCoreObjectWriteContext:(id<ComFasterxmlJacksonCoreObjectWriteContext>)writeCtxt
  ...
  ComFasterxmlJacksonCoreJsonUTF8JsonGenerator_initWithComFasterxmlJacksonCoreObjectWriteContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoOutputStream_withComFasterxmlJacksonCoreSerializableString_withComFasterxmlJacksonCoreIoCharacterEscapes_withComFasterxmlJacksonCorePrettyPrinter_(self, writeCtxt, ioCtxt, features, outArg, rootValueSep, charEsc, pp);
  return self;
}
...
- (instancetype __nonnull)initWithComFasterxmlJacksonCoreObjectWriteContext:(id<ComFasterxmlJacksonCoreObjectWriteContext>)writeCtxt
  ...
  ComFasterxmlJacksonCoreJsonUTF8JsonGenerator_initWithComFasterxmlJacksonCoreObjectWriteContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoOutputStream_withComFasterxmlJacksonCoreSerializableString_withComFasterxmlJacksonCoreIoCharacterEscapes_withComFasterxmlJacksonCorePrettyPrinter_withByteArray_withInt_withBoolean_(self, writeCtxt, ioCtxt, features, outArg, rootValueSep, charEsc, pp, outputBuffer, outputOffset, bufferRecyclable);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "V", 0x11, 7, 8, 4, -1, -1, -1 },
    { NULL, "V", 0x11, 7, 9, 4, -1, -1, -1 },
    { NULL, "V", 0x11, -1, -1, 4, -1, -1, -1 },
    { NULL, "V", 0x11, -1, -1, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 10, 11, 4, -1, -1, -1 },
    { NULL, "V", 0x11, -1, -1, 4, -1, -1, -1 },
    { NULL, "V", 0x14, 12, 3, 4, -1, -1, -1 },
    { NULL, "V", 0x14, 12, 5, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 13, 3, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 13, 14, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 13, 15, 4, -1, -1, -1 },
    { NULL, "V", 0x11, 13, 5, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 16, 17, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 18, 17, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 19, 3, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 19, 20, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 19, 5, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 21, 5, 4, -1, -1, -1 },
    { NULL, "V", 0x11, 19, 15, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 19, 22, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 23, 15, 4, -1, -1, -1 },
    { NULL, "V", 0x2, 24, 15, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 25, 26, 27, -1, -1, -1 },
    { NULL, "I", 0x1, 25, 28, 27, -1, -1, -1 },
    { NULL, "V", 0x1, 29, 30, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 31, 30, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 29, 8, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 32, 8, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 29, 33, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 34, 33, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 29, 35, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 29, 36, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 29, 37, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 29, 38, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 29, 3, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 39, 3, 4, -1, -1, -1 },
    { NULL, "V", 0x1, 40, 41, 4, -1, -1, -1 },
    { NULL, "V", 0x1, -1, -1, 4, -1, -1, -1 },
    { NULL, "V", 0x14, 42, 3, 4, -1, -1, -1 },
    { NULL, "V", 0x1, -1, -1, 4, -1, -1, -1 },
    { NULL, "V", 0x1, -1, -1, 4, -1, -1, -1 },
    { NULL, "V", 0x4, -1, -1, -1, -1, -1, -1 },
    { NULL, "V", 0x12, 43, 44, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 43, 17, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 45, 46, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 45, 15, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 45, 20, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 47, 15, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 47, 20, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 48, 15, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 48, 20, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 49, 15, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 49, 20, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 50, 15, 4, -1, -1, -1 },
    { NULL, "V", 0x12, 50, 20, 4, -1, -1, -1 },
    { NULL, "I", 0x12, 51, 52, 27, -1, -1, -1 },
    { NULL, "I", 0x12, 53, 54, 27, -1, -1, -1 },
    { NULL, "V", 0x12, 55, 17, 27, -1, -1, -1 },
    { NULL, "V", 0x12, 56, 17, 27, -1, -1, -1 },
    { NULL, "V", 0x12, 57, 17, 27, -1, -1, -1 },
    { NULL, "V", 0x14, 58, 26, 27, -1, -1, -1 },
    { NULL, "I", 0x14, 58, 59, 27, -1, -1, -1 },
    { NULL, "I", 0x14, 58, 60, 27, -1, -1, -1 },
    { NULL, "I", 0x12, 61, 62, 4, -1, -1, -1 },
    { NULL, "I", 0x12, 63, 64, 4, -1, -1, -1 },
    { NULL, "V", 0x14, 65, 66, 4, -1, -1, -1 },
    { NULL, "I", 0x12, 67, 66, 4, -1, -1, -1 },
    { NULL, "V", 0x12, -1, -1, 4, -1, -1, -1 },
    { NULL, "I", 0x2, 68, 66, 4, -1, -1, -1 },
    { NULL, "V", 0x14, -1, -1, 4, -1, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  #pragma clang diagnostic ignored "-Wundeclared-selector"
  methods[0].selector = @selector(initWithComFasterxmlJacksonCoreObjectWriteContext:withComFasterxmlJacksonCoreIoIOContext:withInt:withJavaIoOutputStream:withComFasterxmlJacksonCoreSerializableString:withComFasterxmlJacksonCoreIoCharacterEscapes:withComFasterxmlJacksonCorePrettyPrinter:);
  methods[1].selector = @selector(initWithComFasterxmlJacksonCoreObjectWriteContext:withComFasterxmlJacksonCoreIoIOContext:withInt:withJavaIoOutputStream:withComFasterxmlJacksonCoreSerializableString:withComFasterxmlJacksonCoreIoCharacterEscapes:withComFasterxmlJacksonCorePrettyPrinter:withByteArray:withInt:withBoolean:);
  ...
  methods[8].selector = @selector(writeStartArrayWithInt:);
  methods[9].selector = @selector(writeStartArrayWithId:withInt:);
  methods[10].selector = @selector(writeEndArray);
  methods[11].selector = @selector(writeStartObject);
  methods[12].selector = @selector(writeStartObjectWithId:);
  methods[13].selector = @selector(writeEndObject);
  methods[14].selector = @selector(_writePPFieldNameWithNSString:);
  methods[15].selector = @selector(_writePPFieldNameWithComFasterxmlJacksonCoreSerializableString:);
  methods[16].selector = @selector(writeStringWithNSString:);
  methods[17].selector = @selector(writeStringWithJavaIoReader:withInt:);
  methods[18].selector = @selector(writeStringWithCharArray:withInt:withInt:);
  methods[19].selector = @selector(writeStringWithComFasterxmlJacksonCoreSerializableString:);
  methods[20].selector = @selector(writeRawUTF8StringWithByteArray:withInt:withInt:);
  methods[21].selector = @selector(writeUTF8StringWithByteArray:withInt:withInt:);
  methods[22].selector = @selector(writeRawWithNSString:);
  methods[23].selector = @selector(writeRawWithNSString:withInt:withInt:);
  methods[24].selector = @selector(writeRawWithComFasterxmlJacksonCoreSerializableString:);
  methods[25].selector = @selector(writeRawValueWithComFasterxmlJacksonCoreSerializableString:);
  methods[26].selector = @selector(writeRawWithCharArray:withInt:withInt:);
  methods[27].selector = @selector(writeRawWithChar:);
  methods[28].selector = @selector(_writeSegmentedRawWithCharArray:withInt:withInt:);
  methods[29].selector = @selector(_writeRawSegmentWithCharArray:withInt:withInt:);
  methods[30].selector = @selector(writeBinaryWithComFasterxmlJacksonCoreBase64Variant:withByteArray:withInt:withInt:);
  methods[31].selector = @selector(writeBinaryWithComFasterxmlJacksonCoreBase64Variant:withJavaIoInputStream:withInt:);
  methods[32].selector = @selector(writeNumberWithShort:);
  methods[33].selector = @selector(_writeQuotedShortWithShort:);
  methods[34].selector = @selector(writeNumberWithInt:);
  methods[35].selector = @selector(_writeQuotedIntWithInt:);
  methods[36].selector = @selector(writeNumberWithLong:);
  methods[37].selector = @selector(_writeQuotedLongWithLong:);
  methods[38].selector = @selector(writeNumberWithJavaMathBigInteger:);
  methods[39].selector = @selector(writeNumberWithDouble:);
  methods[40].selector = @selector(writeNumberWithFloat:);
  methods[41].selector = @selector(writeNumberWithJavaMathBigDecimal:);
  methods[42].selector = @selector(writeNumberWithNSString:);
  methods[43].selector = @selector(_writeQuotedRawWithNSString:);
  methods[44].selector = @selector(writeBooleanWithBoolean:);
  methods[45].selector = @selector(writeNull);
  methods[46].selector = @selector(_verifyValueWriteWithNSString:);
  methods[47].selector = @selector(flush);
  methods[48].selector = @selector(close);
  methods[49].selector = @selector(_releaseBuffers);
  methods[50].selector = @selector(_writeBytesWithByteArray:);
  methods[51].selector = @selector(_writeBytesWithByteArray:withInt:withInt:);
  methods[52].selector = @selector(_writeStringSegmentsWithNSString:withBoolean:);
  methods[53].selector = @selector(_writeStringSegmentsWithCharArray:withInt:withInt:);
  methods[54].selector = @selector(_writeStringSegmentsWithNSString:withInt:withInt:);
  methods[55].selector = @selector(_writeStringSegmentWithCharArray:withInt:withInt:);
  methods[56].selector = @selector(_writeStringSegmentWithNSString:withInt:withInt:);
  methods[57].selector = @selector(_writeStringSegment2WithCharArray:withInt:withInt:);
  methods[58].selector = @selector(_writeStringSegment2WithNSString:withInt:withInt:);
  methods[59].selector = @selector(_writeStringSegmentASCII2WithCharArray:withInt:withInt:);
  methods[60].selector = @selector(_writeStringSegmentASCII2WithNSString:withInt:withInt:);
  methods[61].selector = @selector(_writeCustomStringSegment2WithCharArray:withInt:withInt:);
  methods[62].selector = @selector(_writeCustomStringSegment2WithNSString:withInt:withInt:);
  methods[63].selector = @selector(_writeCustomEscapeWithByteArray:withInt:withComFasterxmlJacksonCoreSerializableString:withInt:);
  methods[64].selector = @selector(_handleLongCustomEscapeWithByteArray:withInt:withInt:withByteArray:withInt:);
  methods[65].selector = @selector(_writeUTF8SegmentsWithByteArray:withInt:withInt:);
  methods[66].selector = @selector(_writeUTF8SegmentWithByteArray:withInt:withInt:);
  methods[67].selector = @selector(_writeUTF8Segment2WithByteArray:withInt:withInt:);
  methods[68].selector = @selector(_writeBinaryWithComFasterxmlJacksonCoreBase64Variant:withByteArray:withInt:withInt:);
  methods[69].selector = @selector(_writeBinaryWithComFasterxmlJacksonCoreBase64Variant:withJavaIoInputStream:withByteArray:withInt:);
  methods[70].selector = @selector(_writeBinaryWithComFasterxmlJacksonCoreBase64Variant:withJavaIoInputStream:withByteArray:);
  methods[71].selector = @selector(_readMoreWithJavaIoInputStream:withByteArray:withInt:withInt:withInt:);
  methods[72].selector = @selector(_outputRawMultiByteCharWithInt:withCharArray:withInt:withInt:);
  methods[73].selector = @selector(_outputSurrogatesWithInt:withInt:);
  methods[74].selector = @selector(_outputMultiByteCharWithInt:withInt:);
  methods[75].selector = @selector(_writeNull);
  methods[76].selector = @selector(_writeGenericEscapeWithInt:withInt:);
  methods[77].selector = @selector(_flushBuffer);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "HEX_CHARS", "[B", .constantValue.asLong = 0, 0x1a, -1, 69, -1, -1 },
    { "NULL_BYTES", "[B", .constantValue.asLong = 0, 0x1a, -1, 70, -1, -1 },
    { "TRUE_BYTES", "[B", .constantValue.asLong = 0, 0x1a, -1, 71, -1, -1 },
    { "FALSE_BYTES", "[B", .constantValue.asLong = 0, 0x1a, -1, 72, -1, -1 },
  ...
  static const void *ptrTable[] = { "LComFasterxmlJacksonCoreObjectWriteContext;LComFasterxmlJacksonCoreIoIOContext;ILJavaIoOutputStream;LComFasterxmlJacksonCoreSerializableString;LComFasterxmlJacksonCoreIoCharacterEscapes;LComFasterxmlJacksonCorePrettyPrinter;", "LComFasterxmlJacksonCoreObjectWriteContext;LComFasterxmlJacksonCoreIoIOContext;ILJavaIoOutputStream;LComFasterxmlJacksonCoreSerializableString;LComFasterxmlJacksonCoreIoCharacterEscapes;LComFasterxmlJacksonCorePrettyPrinter;[BIZ", "writeFieldName", "LNSString;", "LJavaIoIOException;", "LComFasterxmlJacksonCoreSerializableString;", "_writeUnq", "writeStartArray", "I", "LNSObject;I", "writeStartObject", "LNSObject;", "_writePPFieldName", "writeString", "LJavaIoReader;I", "[CII", "writeRawUTF8String", "[BII", "writeUTF8String", "writeRaw", "LNSString;II", "writeRawValue", "C", "_writeSegmentedRaw", "_writeRawSegment", "writeBinary", "LComFasterxmlJacksonCoreBase64Variant;[BII", "LJavaIoIOException;LComFasterxmlJacksonCoreJsonGenerationException;", "LComFasterxmlJacksonCoreBase64Variant;LJavaIoInputStream;I", "writeNumber", "S", "_writeQuotedShort", "_writeQuotedInt", "J", "_writeQuotedLong", "LJavaMathBigInteger;", "D", "F", "LJavaMathBigDecimal;", "_writeQuotedRaw", "writeBoolean", "Z", "_verifyValueWrite", "_writeBytes", "[B", "_writeStringSegments", "LNSString;Z", "_writeStringSegment", "_writeStringSegment2", "_writeStringSegmentASCII2", "_writeCustomStringSegment2", "_writeCustomEscape", "[BILComFasterxmlJacksonCoreSerializableString;I", "_handleLongCustomEscape", "[BII[BI", "_writeUTF8Segments", "_writeUTF8Segment", "_writeUTF8Segment2", "_writeBinary", "LComFasterxmlJacksonCoreBase64Variant;LJavaIoInputStream;[BI", "LComFasterxmlJacksonCoreBase64Variant;LJavaIoInputStream;[B", "_readMore", "LJavaIoInputStream;[BIII", "_outputRawMultiByteChar", "I[CII", "_outputSurrogates", "II", "_outputMultiByteChar", "_writeGenericEscape", &ComFasterxmlJacksonCoreJsonUTF8JsonGenerator_HEX_CHARS, &ComFasterxmlJacksonCoreJsonUTF8JsonGenerator_NULL_BYTES, &ComFasterxmlJacksonCoreJsonUTF8JsonGenerator_TRUE_BYTES, &ComFasterxmlJacksonCoreJsonUTF8JsonGenerator_FALSE_BYTES };
  static const J2ObjcClassInfo _ComFasterxmlJacksonCoreJsonUTF8JsonGenerator = { "UTF8JsonGenerator", "com.fasterxml.jackson.core.json", ptrTable, methods, fields, 7, 0x1, 78, 24, -1, -1, -1, -1, -1 };
...
void ComFasterxmlJacksonCoreJsonUTF8JsonGenerator_initWithComFasterxmlJacksonCoreObjectWriteContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoOutputStream_withComFasterxmlJacksonCoreSerializableString_withComFasterxmlJacksonCoreIoCharacterEscapes_withComFasterxmlJacksonCorePrettyPrinter_(ComFasterxmlJacksonCoreJsonUTF8JsonGenerator *self, id<ComFasterxmlJacksonCoreObjectWriteContext> writeCtxt, ComFasterxmlJacksonCoreIoIOContext *ioCtxt, jint features, JavaIoOutputStream *outArg, id<ComFasterxmlJacksonCoreSerializableString> rootValueSep, ComFasterxmlJacksonCoreIoCharacterEscapes *charEsc, id<ComFasterxmlJacksonCorePrettyPrinter> pp) {
  ...
  JreStrongAssign(&self->_outputBuffer_, [((ComFasterxmlJacksonCoreIoIOContext *) nil_chk(ioCtxt)) allocWriteEncodingBuffer]);
  self->_outputEnd_ = ((IOSByteArray *) nil_chk(self->_outputBuffer_))->size_;
  self->_outputMaxContiguous_ = JreRShift32(self->_outputEnd_, 3);
  JreStrongAssign(&self->_charBuffer_, [ioCtxt allocConcatBuffer]);
...
ComFasterxmlJacksonCoreJsonUTF8JsonGenerator *new_ComFasterxmlJacksonCoreJsonUTF8JsonGenerator_initWithComFasterxmlJacksonCoreObjectWriteContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoOutputStream_withComFasterxmlJacksonCoreSerializableString_withComFasterxmlJacksonCoreIoCharacterEscapes_withComFasterxmlJacksonCorePrettyPrinter_(id<ComFasterxmlJacksonCoreObjectWriteContext> writeCtxt, ComFasterxmlJacksonCoreIoIOContext *ioCtxt, jint features, JavaIoOutputStream *outArg, id<ComFasterxmlJacksonCoreSerializableString> rootValueSep, ComFasterxmlJacksonCoreIoCharacterEscapes *charEsc, id<ComFasterxmlJacksonCorePrettyPrinter> pp) {
  J2OBJC_NEW_IMPL(ComFasterxmlJacksonCoreJsonUTF8JsonGenerator, initWithComFasterxmlJacksonCoreObjectWriteContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoOutputStream_withComFasterxmlJacksonCoreSerializableString_withComFasterxmlJacksonCoreIoCharacterEscapes_withComFasterxmlJacksonCorePrettyPrinter_, writeCtxt, ioCtxt, features, outArg, rootValueSep, charEsc, pp)
}
...
ComFasterxmlJacksonCoreJsonUTF8JsonGenerator *create_ComFasterxmlJacksonCoreJsonUTF8JsonGenerator_initWithComFasterxmlJacksonCoreObjectWriteContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoOutputStream_withComFasterxmlJacksonCoreSerializableString_withComFasterxmlJacksonCoreIoCharacterEscapes_withComFasterxmlJacksonCorePrettyPrinter_(id<ComFasterxmlJacksonCoreObjectWriteContext> writeCtxt, ComFasterxmlJacksonCoreIoIOContext *ioCtxt, jint features, JavaIoOutputStream *outArg, id<ComFasterxmlJacksonCoreSerializableString> rootValueSep, ComFasterxmlJacksonCoreIoCharacterEscapes *charEsc, id<ComFasterxmlJacksonCorePrettyPrinter> pp) {
  J2OBJC_CREATE_IMPL(ComFasterxmlJacksonCoreJsonUTF8JsonGenerator, initWithComFasterxmlJacksonCoreObjectWriteContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoOutputStream_withComFasterxmlJacksonCoreSerializableString_withComFasterxmlJacksonCoreIoCharacterEscapes_withComFasterxmlJacksonCorePrettyPrinter_, writeCtxt, ioCtxt, features, outArg, rootValueSep, charEsc, pp)
}
...
void ComFasterxmlJacksonCoreJsonUTF8JsonGenerator_initWithComFasterxmlJacksonCoreObjectWriteContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoOutputStream_withComFasterxmlJacksonCoreSerializableString_withComFasterxmlJacksonCoreIoCharacterEscapes_withComFasterxmlJacksonCorePrettyPrinter_withByteArray_withInt_withBoolean_(ComFasterxmlJacksonCoreJsonUTF8JsonGenerator *self, id<ComFasterxmlJacksonCoreObjectWriteContext> writeCtxt, ComFasterxmlJacksonCoreIoIOContext *ioCtxt, jint features, JavaIoOutputStream *outArg, id<ComFasterxmlJacksonCoreSerializableString> rootValueSep, ComFasterxmlJacksonCoreIoCharacterEscapes *charEsc, id<ComFasterxmlJacksonCorePrettyPrinter> pp, IOSByteArray *outputBuffer, jint outputOffset, jboolean bufferRecyclable) {
  ...
  self->_outputEnd_ = ((IOSByteArray *) nil_chk(self->_outputBuffer_))->size_;
  self->_outputMaxContiguous_ = (JreRShift32(self->_outputEnd_, 3));
  JreStrongAssign(&self->_charBuffer_, [((ComFasterxmlJacksonCoreIoIOContext *) nil_chk(ioCtxt)) allocConcatBuffer]);
  self->_charBufferLength_ = ((IOSCharArray *) nil_chk(self->_charBuffer_))->size_;
}
...
ComFasterxmlJacksonCoreJsonUTF8JsonGenerator *new_ComFasterxmlJacksonCoreJsonUTF8JsonGenerator_initWithComFasterxmlJacksonCoreObjectWriteContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoOutputStream_withComFasterxmlJacksonCoreSerializableString_withComFasterxmlJacksonCoreIoCharacterEscapes_withComFasterxmlJacksonCorePrettyPrinter_withByteArray_withInt_withBoolean_(id<ComFasterxmlJacksonCoreObjectWriteContext> writeCtxt, ComFasterxmlJacksonCoreIoIOContext *ioCtxt, jint features, JavaIoOutputStream *outArg, id<ComFasterxmlJacksonCoreSerializableString> rootValueSep, ComFasterxmlJacksonCoreIoCharacterEscapes *charEsc, id<ComFasterxmlJacksonCorePrettyPrinter> pp, IOSByteArray *outputBuffer, jint outputOffset, jboolean bufferRecyclable) {
  J2OBJC_NEW_IMPL(ComFasterxmlJacksonCoreJsonUTF8JsonGenerator, initWithComFasterxmlJacksonCoreObjectWriteContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoOutputStream_withComFasterxmlJacksonCoreSerializableString_withComFasterxmlJacksonCoreIoCharacterEscapes_withComFasterxmlJacksonCorePrettyPrinter_withByteArray_withInt_withBoolean_, writeCtxt, ioCtxt, features, outArg, rootValueSep, charEsc, pp, outputBuffer, outputOffset, bufferRecyclable)
}
...
ComFasterxmlJacksonCoreJsonUTF8JsonGenerator *create_ComFasterxmlJacksonCoreJsonUTF8JsonGenerator_initWithComFasterxmlJacksonCoreObjectWriteContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoOutputStream_withComFasterxmlJacksonCoreSerializableString_withComFasterxmlJacksonCoreIoCharacterEscapes_withComFasterxmlJacksonCorePrettyPrinter_withByteArray_withInt_withBoolean_(id<ComFasterxmlJacksonCoreObjectWriteContext> writeCtxt, ComFasterxmlJacksonCoreIoIOContext *ioCtxt, jint features, JavaIoOutputStream *outArg, id<ComFasterxmlJacksonCoreSerializableString> rootValueSep, ComFasterxmlJacksonCoreIoCharacterEscapes *charEsc, id<ComFasterxmlJacksonCorePrettyPrinter> pp, IOSByteArray *outputBuffer, jint outputOffset, jboolean bufferRecyclable) {
  J2OBJC_CREATE_IMPL(ComFasterxmlJacksonCoreJsonUTF8JsonGenerator, initWithComFasterxmlJacksonCoreObjectWriteContext_withComFasterxmlJacksonCoreIoIOContext_withInt_withJavaIoOutputStream_withComFasterxmlJacksonCoreSerializableString_withComFasterxmlJacksonCoreIoCharacterEscapes_withComFasterxmlJacksonCorePrettyPrinter_withByteArray_withInt_withBoolean_, writeCtxt, ioCtxt, features, outArg, rootValueSep, charEsc, pp, outputBuffer, outputOffset, bufferRecyclable)
}
...
void ComFasterxmlJacksonCoreJsonUTF8JsonGenerator_writeEndArray(ComFasterxmlJacksonCoreJsonUTF8JsonGenerator *self) {
  if (![((ComFasterxmlJacksonCoreJsonJsonWriteContext *) nil_chk(self->_outputContext_)) inArray]) {
    [self _reportErrorWithNSString:JreStrcat("$$", @"Current context not Array but ", [((ComFasterxmlJacksonCoreJsonJsonWriteContext *) nil_chk(self->_outputContext_)) typeDesc])];
  }
  if (self->_cfgPrettyPrinter_ != nil) {
    [self->_cfgPrettyPrinter_ writeEndArrayWithComFasterxmlJacksonCoreJsonGenerator:self withInt:[((ComFasterxmlJacksonCoreJsonJsonWriteContext *) nil_chk(self->_outputContext_)) getEntryCount]];
  }
  else {
  ...
  JreStrongAssign(&self->_outputContext_, [((ComFasterxmlJacksonCoreJsonJsonWriteContext *) nil_chk(self->_outputContext_)) clearAndGetParent]);
}

void ComFasterxmlJacksonCoreJsonUTF8JsonGenerator_writeEndObject(ComFasterxmlJacksonCoreJsonUTF8JsonGenerator *self) {
  if (![((ComFasterxmlJacksonCoreJsonJsonWriteContext *) nil_chk(self->_outputContext_)) inObject]) {
    [self _reportErrorWithNSString:JreStrcat("$$", @"Current context not Object but ", [((ComFasterxmlJacksonCoreJsonJsonWriteContext *) nil_chk(self->_outputContext_)) typeDesc])];
  }
  if (self->_cfgPrettyPrinter_ != nil) {
    [self->_cfgPrettyPrinter_ writeEndObjectWithComFasterxmlJacksonCoreJsonGenerator:self withInt:[((ComFasterxmlJacksonCoreJsonJsonWriteContext *) nil_chk(self->_outputContext_)) getEntryCount]];
  }
  else {
    if (self->_outputTail_ >= self->_outputEnd_) {
      ComFasterxmlJacksonCoreJsonUTF8JsonGenerator__flushBuffer(self);
...
void ComFasterxmlJacksonCoreJsonUTF8JsonGenerator__writePPFieldNameWithNSString_(ComFasterxmlJacksonCoreJsonUTF8JsonGenerator *self, NSString *name) {
  jint status = [((ComFasterxmlJacksonCoreJsonJsonWriteContext *) nil_chk(self->_outputContext_)) writeFieldNameWithNSString:name];
  if (status == ComFasterxmlJacksonCoreJsonJsonWriteContext_STATUS_EXPECT_VALUE) {
    [self _reportErrorWithNSString:@"Can not write a field name, expecting a value"];
  }
  if (status == ComFasterxmlJacksonCoreJsonJsonWriteContext_STATUS_OK_AFTER_COMMA) {
...
void ComFasterxmlJacksonCoreJsonUTF8JsonGenerator__writePPFieldNameWithComFasterxmlJacksonCoreSerializableString_(ComFasterxmlJacksonCoreJsonUTF8JsonGenerator *self, id<ComFasterxmlJacksonCoreSerializableString> name) {
  jint status = [((ComFasterxmlJacksonCoreJsonJsonWriteContext *) nil_chk(self->_outputContext_)) writeFieldNameWithNSString:[((id<ComFasterxmlJacksonCoreSerializableString>) nil_chk(name)) getValue]];
  if (status == ComFasterxmlJacksonCoreJsonJsonWriteContext_STATUS_EXPECT_VALUE) {
    [self _reportErrorWithNSString:@"Can not write a field name, expecting a value"];
  }
  if (status == ComFasterxmlJacksonCoreJsonJsonWriteContext_STATUS_OK_AFTER_COMMA) {
