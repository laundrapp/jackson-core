...
- (void)setEncodingWithComFasterxmlJacksonCoreJsonEncoding:(ComFasterxmlJacksonCoreJsonEncoding *)enc {
  JreStrongAssign(&_encoding_, enc);
}

- (ComFasterxmlJacksonCoreIoIOContext *)withEncodingWithComFasterxmlJacksonCoreJsonEncoding:(ComFasterxmlJacksonCoreJsonEncoding *)enc {
  JreStrongAssign(&_encoding_, enc);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LComFasterxmlJacksonCoreIoIOContext;", 0x1, 3, 2, -1, -1, -1, -1 },
  ...
  methods[1].selector = @selector(setEncodingWithComFasterxmlJacksonCoreJsonEncoding:);
  methods[2].selector = @selector(withEncodingWithComFasterxmlJacksonCoreJsonEncoding:);
  ...
  static const void *ptrTable[] = { "LComFasterxmlJacksonCoreUtilBufferRecycler;LNSObject;Z", "setEncoding", "LComFasterxmlJacksonCoreJsonEncoding;", "withEncoding", "allocReadIOBuffer", "I", "allocWriteEncodingBuffer", "allocBase64Buffer", "allocTokenBuffer", "allocNameCopyBuffer", "releaseReadIOBuffer", "[B", "releaseWriteEncodingBuffer", "releaseBase64Buffer", "releaseTokenBuffer", "[C", "releaseConcatBuffer", "releaseNameCopyBuffer", "_verifyAlloc", "LNSObject;", "_verifyRelease", "[B[B", "[C[C" };
