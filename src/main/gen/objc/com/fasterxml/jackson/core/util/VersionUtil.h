...
/*!
 @brief Will attempt to load the maven version for the given groupId and
...
FOUNDATION_EXPORT ComFasterxmlJacksonCoreVersion *ComFasterxmlJacksonCoreUtilVersionUtil_mavenVersionForWithJavaLangClassLoader_withNSString_withNSString_(JavaLangClassLoader *cl, NSString *groupId, NSString *artifactId);
