...
- (ComFasterxmlJacksonCoreFilterTokenFilterContext *)createChildArrayContextWithComFasterxmlJacksonCoreFilterTokenFilter:(ComFasterxmlJacksonCoreFilterTokenFilter *)filter
  ...
  if (ctxt == nil) {
    JreStrongAssign(&_child_, ctxt = create_ComFasterxmlJacksonCoreFilterTokenFilterContext_initWithInt_withComFasterxmlJacksonCoreFilterTokenFilterContext_withComFasterxmlJacksonCoreFilterTokenFilter_withBoolean_(ComFasterxmlJacksonCoreJsonStreamContext_TYPE_ARRAY, self, filter, writeStart));
    return ctxt;
  }
  return [ctxt resetWithInt:ComFasterxmlJacksonCoreJsonStreamContext_TYPE_ARRAY withComFasterxmlJacksonCoreFilterTokenFilter:filter withBoolean:writeStart];
}
...
- (ComFasterxmlJacksonCoreFilterTokenFilterContext *)createChildObjectContextWithComFasterxmlJacksonCoreFilterTokenFilter:(ComFasterxmlJacksonCoreFilterTokenFilter *)filter
  ...
  ComFasterxmlJacksonCoreFilterTokenFilterContext *ctxt = _child_;
  if (ctxt == nil) {
    JreStrongAssign(&_child_, ctxt = create_ComFasterxmlJacksonCoreFilterTokenFilterContext_initWithInt_withComFasterxmlJacksonCoreFilterTokenFilterContext_withComFasterxmlJacksonCoreFilterTokenFilter_withBoolean_(ComFasterxmlJacksonCoreJsonStreamContext_TYPE_OBJECT, self, filter, writeStart));
    return ctxt;
  }
  return [ctxt resetWithInt:ComFasterxmlJacksonCoreJsonStreamContext_TYPE_OBJECT withComFasterxmlJacksonCoreFilterTokenFilter:filter withBoolean:writeStart];
}
...
- (ComFasterxmlJacksonCoreJsonToken *)nextTokenToRead {
  ...
  if (_needToHandleName_ && (_type_ == ComFasterxmlJacksonCoreJsonStreamContext_TYPE_OBJECT)) {
    _needToHandleName_ = false;
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[16].selector = @selector(getCurrentName);
...
ComFasterxmlJacksonCoreFilterTokenFilterContext *ComFasterxmlJacksonCoreFilterTokenFilterContext_createRootContextWithComFasterxmlJacksonCoreFilterTokenFilter_(ComFasterxmlJacksonCoreFilterTokenFilter *filter) {
  ...
  return create_ComFasterxmlJacksonCoreFilterTokenFilterContext_initWithInt_withComFasterxmlJacksonCoreFilterTokenFilterContext_withComFasterxmlJacksonCoreFilterTokenFilter_withBoolean_(ComFasterxmlJacksonCoreJsonStreamContext_TYPE_ROOT, nil, filter, true);
}
...
void ComFasterxmlJacksonCoreFilterTokenFilterContext__writePathWithComFasterxmlJacksonCoreJsonGenerator_(ComFasterxmlJacksonCoreFilterTokenFilterContext *self, ComFasterxmlJacksonCoreJsonGenerator *gen) {
  ...
  if (self->_startHandled_) {
    ...
    if (self->_type_ == ComFasterxmlJacksonCoreJsonStreamContext_TYPE_OBJECT) {
      [((ComFasterxmlJacksonCoreJsonGenerator *) nil_chk(gen)) writeStartObject];
      if (self->_needToHandleName_) {
        self->_needToHandleName_ = false;
    ...
    else if (self->_type_ == ComFasterxmlJacksonCoreJsonStreamContext_TYPE_ARRAY) {
      [((ComFasterxmlJacksonCoreJsonGenerator *) nil_chk(gen)) writeStartArray];
    }
  }
}
